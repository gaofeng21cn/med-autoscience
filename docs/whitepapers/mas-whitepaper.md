...
![Med Auto Science 从研究问题到发表交接的连续研究线。](../../assets/branding/medautoscience-overview-v3.png)
...
执行与审阅由不同角色承担。撰写或分析工作完成后，独立审阅者基于同一版材料重新检查问题、证据和主张。这样的外部视角能捕捉创作者的盲区，并让质量门由独立审阅确认。

### 人机协作

AI 主动承担高负荷工作，研究者保留高价值判断。系统把临床解释、伦理边界、投稿授权等需要人类决定的问题明确提出。

MAS 以论文作者的立场起草读者可见稿件。科学证据不足时，内容回到证据、分析或研究设计环节补齐，不能伪装成等待作者填空。只有伦理批准号、中心名称、作者贡献或资助信息这类只有作者能确认的客观事实，才保留清楚、局部的待确认项。候选稿进入正式独立审阅后，审阅者只检查同一版材料，避免边改边审让结论失去共同基准。
...
真实课题沿六个公开研究阶段推进：方向与路线选择、基线与证据准备、有边界的分析推进、稿件写作、审阅与质量门、定稿与发表交接。六个阶段组成一条可前进、可回退的连续研究路线；七个能力模块则在相应阶段提供专业能力，其中证据、图表和审阅会跨越多个阶段：
...
| **审阅修订** | 审阅与质量门，并按需回到前序阶段 | 独立审阅者把医学、统计、引用和一致性问题转成修订任务 |
| **交付准备** | 定稿与发表交接 | 稿件、图表、证据、审阅记录与未关闭问题形成可复查材料 |

医学写作、独立审阅、统计审查、文献研究、图表与表格设计、投稿准备和数据治理等专业能力在同一条研究线中协作。普通用户只需选择 MAS，不需要分别安装、理解或编排这些能力；这些专业能力由 `mas-scholar-skills` 作为 MAS 的必需能力依赖提供，MAS 始终对医学研究方法和质量判断负责。
...
已暂停或已停止的课题不会因为运行环境恢复就自动继续。只有用户明确选择继续该课题，研究线才重新进入活跃状态。技术检查不能替代研究者对真实课题的继续授权。
...
**主张。** MAS 根据现有证据形成稿件草案，主张是“该指标与短期不良结局独立相关，并可能用于风险预测”。每句话都连接到对应结果、图表或文献依据。稿件中缺失的伦理批准号是作者才能确认的客观事实，因此只在方法部分保留一处局部待确认项；亚组结果不稳定属于科学证据缺口，必须回到分析环节，不能交给作者填空。

**独立审阅。** 候选稿冻结后，一位没有参与当前撰写的审阅者只审阅这一版材料，并发现两点：观察性设计只支持关联表达；缺少外部验证时，“用于风险预测”过强。审阅者同时指出摘要、讨论和图注的表述强度不一致。
...
当一轮工作已经产生可消费的稿件、分析、图表或证据增量，但仍有明确的可修问题时，研究线可以带着质量债继续到下一阶段。这仅表示“已有下一步可用的成果”；质量通过仍由相应质量门证明。

质量债会关闭质量通过、正式交付和投稿就绪等承诺，直到对应问题被补证、修订、独立复核或由有权者决定。当一轮工作缺少可消费成果，或遇到真实的权限、安全、不可逆操作与人工决策边界时，研究线会停下来等待处理。
...
用户专注于研究，底层运行与工具组合由系统管理。MAS 说明研究阶段、专业能力、质量边界和环境需求；OPL Framework 提供统一入口、工作台、运行、恢复、证据和交接。用户看到连续体验，医学判断仍由 MAS 与研究者持有。
...
- **执行与审阅相互独立。** 审阅者用不同视角检查执行者的盲区，质量门由独立审阅关闭。
- **质量债与就绪分别表达。** 可消费成果可以继续推进，投稿和发布承诺在质量债解决后开放。
...
MAS 负责需要专业裁决的医学判断：研究与数据边界、独立审阅、论文质量、成果是否接受，以及何时必须交给研究者决定。通用运行和界面由 OPL Framework 与工作台承载。

## 与 One Person Lab 的关系

Med Auto Science 是 One Person Lab 系列中的医学研究 Foundry Agent。这条边界让每一层只负责自己最擅长的事：

```text
用户的医学研究目标
  -> OPL App / 在线工作台：统一入口、进度、产物、卡点和下一步
      -> OPL Framework：阶段运行、恢复、证据与交接
          -> MAS：研究阶段、医学方法、独立审阅与质量判断
              -> 研究者：临床解释、伦理合规、主张接受与最终投稿
```

这种分工减少重复平台，让界面、运行、通用工具与医学结论各归其位。用户感知到一条已经组织好的连续科研工作线，背后的工具可以演进，医学责任不会因此漂移。

## 本文边界

本文聚焦 MAS 的产品思想、设计原则和用户价值。安装说明、运行状态证明、论文质量证明、投稿授权和发表承诺分别由对应权威来源提供。

具体课题的进度、论文质量与投稿就绪，必须由当前稿件、图表、证据记录、独立审阅和研究者决定共同证明。
...
- [架构概览](https://github.com/gaofeng21cn/med-autoscience/blob/main/docs/architecture.md)：MAS、OPL Framework 与专业责任边界。
...
MAS 的目标，是让医学研究团队拥有一条持续推进的智能研究线：从问题出发，连接数据、证据、分析、图表、稿件、独立审阅、修订与交付。

AI 承担重活，研究判断保持有依据；成果持续前进，质量债与投稿就绪清楚区分；用户专注研究，OPL 与 MAS 维持运行和责任边界。这就是 Med Auto Science 的设计理念：主动推进，证据约束，独立审阅，交付可复查。
