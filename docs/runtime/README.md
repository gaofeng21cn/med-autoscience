...
- [Research Integrity Layer Contract](./contracts/research_integrity_layer.md)：固定 OPL Connect provider lookup -> MAS RI Gate -> AI reviewer / publication gate consumer 的非权威输入链；合同、docs 和 meta 绿不能声明 live provider truth、owner receipt、publication-ready 或 current-package freshness。
