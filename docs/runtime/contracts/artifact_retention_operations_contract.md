...
SQLite lifecycle store 只作为 sidecar index/read model/receipt 查询层。它可以索引 retention plan、archive ref、checksum、restore proof 和 owner route receipt；论文真相、用户干预记忆和可交付文件仍保留文件形态。
