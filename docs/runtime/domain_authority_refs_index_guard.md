...
- `med_autoscience.runtime_protocol.domain_authority_refs_index` 仅可作为显式 opt-in replay / local inspection 的 MAS domain authority refs SQLite helper，不得作为默认 active runtime/read-model 写面；
