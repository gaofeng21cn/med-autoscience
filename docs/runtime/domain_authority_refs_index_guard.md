...
- `tests/test_opl_family_persistence_adapter.py`、`tests/test_opl_standard_pack.py`、`tests/test_test_lane_governance.py`：覆盖 refs-only adoption surface、standard-agent purity boundary 和 test-lane manifest mirror。
