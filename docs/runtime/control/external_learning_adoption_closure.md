...
- `scholarskills_module_capability`：图、表、统计、文献、写作、review、投稿和数据治理八类 active 学术能力以 `opl.scholarskills.<module>` descriptor、required ref families、execution receipt candidate 和 file-materialized package manifest 暴露给 MAS。
