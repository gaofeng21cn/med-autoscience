...
- `current_executable_owner_action_parts/*` 中仍声明 `_authority_boundary()` 的 superseded successor diagnostic producers 统一携带同一 noncanonical boundary。
