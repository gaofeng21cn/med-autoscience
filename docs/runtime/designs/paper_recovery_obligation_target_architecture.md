...
- 读取 `recovery_obligation_id`、`phase`、`conditions`、`next_safe_action`、`current_work_unit_identity`、`provider_attempt_identity`、`terminal_closeout_refs` 和 `consumed_or_rejected_refs`。
