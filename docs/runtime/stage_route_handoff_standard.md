...
- Codex 从 OPL StageRun/current-control/hosted workbench 读取 current refs，并可把 MAS legacy `study_state_matrix` 当 internal diagnostic drilldown；结合 stage artifact、阴性结果与 route-back hints，自主选择任意 declared stage。
