...
| Quality cycle | `contracts/stage_quality_cycle_policy.json`；六个 policy 均满足严格 Framework schema，四个开放判断/产物 Stage 默认三轮 repair + re-review；Meta Review 不递归 Review，final handoff 只机械封装 exact reviewed bytes |
