...
| Stage-native paper authority reader | `paper_authority_cutover/current_body` 是 reader authority surface；writer/materializer 仍必须走 MAS owner-authorized callable surface，不能把 reader authority 升级为写权限。 |
