...
| Hosted runtime | Hosted autonomous runtime 默认由 OPL/Temporal 承担；MAS 不持有 generic daemon、scheduler、attempt loop、queue、retry/dead-letter、resume、worker residency、generic lifecycle/index 或 App/workbench shell。 |
