...
这是一项 repo/source/control-plane 结论，不是 live readiness 结论。L1-L4 已关闭；L5 正在完成双仓最终提交、push、target-ref readback 与终局文档同步。Live evidence 仍后置且独立为 `partial_deferred`。
