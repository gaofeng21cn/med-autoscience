...
| --- | --- |
| Identity | canonical id `mas`；`med-autoscience` 只作 repo/package/plugin locator |
| Package | immutable SemVer `0.2.2`；`mas-scholar-skills >=0.2.0 <0.3.0` 为硬依赖，生命周期统一归 `opl packages` |
