...
- Hypothesis portfolio / evidence pack 只能作为 MAS-owned 研究探索和证据审计 shape。Co-Scientist 式 generation、reflection、ranking、Elo、proximity、evolution 或 meta-review signal 都是 advisory selection / reviewer-briefing 输入；它们不得替代 source readiness verdict、AI reviewer / auditor quality gate、publication gate、human/expert gate、artifact authority、memory accept/reject decision、owner receipt 或 stable typed blocker。
