...
| [study-workflow](./study-workflow/README.md) | Stage-led research autonomy, publication route memory, study archetypes, data asset, submission revision, and workspace workflow rules. |
