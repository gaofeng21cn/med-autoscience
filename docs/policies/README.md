...
| [study-workflow](./study-workflow/) | Stage-led research autonomy, study route, data asset, research route memory, archetype, submission revision, and workspace workflow rules. |
