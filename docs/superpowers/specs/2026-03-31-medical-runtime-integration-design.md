...
- `cohort flow`
- `TRIPOD / STROBE / CONSORT` style checklist contracts

目标：

- 把更细粒度的医学期刊 schema 提升为一等公民 gate
...
5. delivery 之前存在明确且可阻断的医学审计 gate

## Recommended Next Step

下一步不应直接开写代码，而应基于本设计写一份 implementation plan，按以下顺序拆任务：

1. `medical_analysis_contract + startup_contract expansion`
...
5. `medical literature audit gate`
