...
3. **横向 stage 形式层**：Stage surface standardization 负责把 MAS 的 stage card、route contract、prompt/skill、tool surface、knowledge packet、closeout memory、quality pack 与 OPL projection boundary 做成统一维护形态。它不替代 P0/P2，而是所有 stage / prompt / skill / quality 变更的形式合同。
...
| Cross-cutting form | [MAS Stage Surface Standardization Program](./stage_surface_standardization_program.md) | `active_cross_cutting_program` | 统一 MAS stage 的人读 surface、machine source、prompt/skill、tool、knowledge、closeout、quality pack 与 OPL projection boundary。 | stage / prompt / skill / knowledge / quality 变更先按该模板归一，再进入 P0/P2/P1 对应 owner surface。 |
...
| `4` | `stage_surface_standardization` | `stage_surface_standardization_program.md` | 横向统一 stage card、prompt/skill、tool surface、knowledge packet、closeout memory、quality pack 和 OPL projection boundary，避免 prompt/skill/quality 继续分散增长。 | 每个主 stage 都有同构人读 surface，knowledge/closeout 义务明确，quality pack 可组合，machine truth 仍来自 canonical contract。 |
...
| `stage_surface_standardization_program.md` | 横向 stage 形式统一 owner | 保留为 active cross-cutting program。凡是修改 stage prompt、skill、knowledge packet、closeout memory、quality pack、stage descriptor 或 OPL projection boundary，先按本文归一。 |
