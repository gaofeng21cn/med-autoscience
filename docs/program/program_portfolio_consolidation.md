...
| `ai_first_paper_autonomy_closure_program.md` | active execution program | 全自动高质量医学论文主闭环 program：AI reviewer、repair work units、analysis direction autonomy、manuscript rewrite、gate replay、real paper soak。 |
