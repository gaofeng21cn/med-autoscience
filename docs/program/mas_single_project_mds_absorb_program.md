...
- 已有 root Git 如有 commits、dirty state 或 stashes，必须完成 inventory、archive、restore command、sha256 和 verify ledger 后才允许 remove；有 remotes、locks 或 linked worktrees 时继续 block 到 maintainer audit。
