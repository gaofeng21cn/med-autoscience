...
| `publication_route_memory_receipt_scaleout` | body-free receipt inventory 已能投影 migration/writeback accepted/rejected refs；仍需更多真实 accepted/rejected lessons。 | Study Workflow / publication route memory policy | 多 paper-line router receipts、body-free inventory、OPL/Aion ref-only 分组。 |
