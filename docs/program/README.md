...
- [Program Portfolio Consolidation](./program_portfolio_consolidation.md): the current portfolio entry. Read it first for the target/enabler/foundation split, the content-level disposition table, and the archive rule.
...
Before adding a program board or editing an old plan, map each content block through [Program Portfolio Consolidation](./program_portfolio_consolidation.md): target/outcome, active enabler, landed foundation, support reference, dated snapshot, or tombstone.
