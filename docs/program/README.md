...
| Cross-cutting stage form | [MAS Stage Surface Standardization Program](./stage_surface_standardization_program.md) | Keeps every MAS stage expressed through a consistent stage card, route contract, prompt/skill surface, tool surface, knowledge packet, closeout obligation, quality gate, and OPL projection boundary. |
