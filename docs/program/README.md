...
- [MAS Stage Surface Standardization Program](./stage_surface_standardization_program.md): the cross-cutting stage-form program. Use it when changing stage prompts, skills, tools, knowledge packets, closeout memory, quality packs, final human-readable Stage Deliverable Review Pages, Stage Deliverable Indexes, or OPL stage descriptors.
