...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-05-01-mas-mds-history-plan-closeout | completion ledger; parked telemetry closeout; study_progress SLO projection; parked/liveness consistency; manual_finishing visible-state normalization; live-regression fixtures | in_progress | in_progress | no | no | pending DM-CVD 002/003 reread | none | pending verification and absorb |
