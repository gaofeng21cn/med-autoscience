...
| --- | --- | --- | --- | --- |
| `2026-04-06` | `Nature Medicine` `2025` 炎症图谱图 1 | 复合式图谱结构、细胞群嵌入、签名热图、跨层叙事组合 | `D/E/G`，尤其是 atlas composite 一类复合图式 | 其中 `embedding + signature heatmap` 与 atlas overview baseline 子能力已于 `2026-04-08` 正式入库；更大 spatial/trajectory 变体仍为候选 |
