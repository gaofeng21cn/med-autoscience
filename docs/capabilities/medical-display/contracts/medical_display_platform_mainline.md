...
- `docs/capabilities/medical-display/contracts/medical_display_platform_mainline.md`
- `docs/capabilities/medical-display/board/medical_display_active_board.md`
- `docs/capabilities/medical-display/catalogs/medical_display_template_backlog.md`
