...
- Implemented evidence figure templates: `37`
- Illustration shells: `2`
- Table shells: `5`
- Total implemented display templates: `44`
...
- Ranked feature-attribution summary, multi-panel dependence explanation, and patient-level additive contribution paths under controlled point geometry, shared colorbar governance, explicit zero-reference guides, and deterministic `baseline + contributions = prediction` reconciliation.

Authoritative contract:

- Input schemas: `shap_summary_inputs_v1`, `shap_dependence_panel_inputs_v1`, `shap_waterfall_local_explanation_panel_inputs_v1`
- Renderer family: `python`
- QC: `publication_shap_summary`, `publication_shap_dependence_panel`, `publication_shap_waterfall_local_explanation_panel`
...
- lower-bound focus: panel-feature uniqueness, finite point coordinates, zero-line containment, shared colorbar governance, panel-label anchoring, contribution direction consistency, and deterministic `baseline + contributions = prediction` reconciliation for manuscript-facing local explanation panels
