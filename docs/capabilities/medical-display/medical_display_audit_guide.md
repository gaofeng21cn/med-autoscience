...
- Implemented evidence figure templates: `65`
- Illustration shells: `7`
- Table shells: `5`
- Total implemented display templates: `77`
...
| Matrix Pattern | 7 | `heatmap_group_comparison_inputs_v1`, `performance_heatmap_inputs_v1`, `correlation_heatmap_inputs_v1`, `clustered_heatmap_inputs_v1`, `gsva_ssgsea_heatmap_inputs_v1`, `pathway_enrichment_dotplot_panel_inputs_v1`, `oncoplot_mutation_landscape_panel_inputs_v1` | `publication_heatmap`, `publication_pathway_enrichment_dotplot_panel`, `publication_oncoplot_mutation_landscape_panel` |
...
- Group contrast matrices, audited performance grids, symmetric correlation structure, externally fixed clustered ordering, omics-native GSVA/ssGSEA program heatmaps, shared-pathway enrichment dotplots, and bounded oncoplot mutation landscapes that jointly govern effect direction, effect strength, hit-size encoding, shared pathway ordering, declared sample/gene ordering, annotation-track completeness, top burden sidebars, and right-side altered-frequency semantics.

Authoritative contract:

- Input schemas: `heatmap_group_comparison_inputs_v1`, `performance_heatmap_inputs_v1`, `correlation_heatmap_inputs_v1`, `clustered_heatmap_inputs_v1`, `gsva_ssgsea_heatmap_inputs_v1`, `pathway_enrichment_dotplot_panel_inputs_v1`, `oncoplot_mutation_landscape_panel_inputs_v1`
- Renderer families: `r_ggplot2`, `python`
- QC: `publication_heatmap`, `publication_pathway_enrichment_dotplot_panel`, `publication_oncoplot_mutation_landscape_panel`
