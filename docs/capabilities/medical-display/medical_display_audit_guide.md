...
- Implemented evidence figure templates: `38`
- Illustration shells: `2`
- Table shells: `5`
- Total implemented display templates: `45`
...
| Model Explanation | 4 | `shap_summary_inputs_v1`, `shap_dependence_panel_inputs_v1`, `shap_waterfall_local_explanation_panel_inputs_v1`, `shap_force_like_summary_panel_inputs_v1` | `publication_shap_summary`, `publication_shap_dependence_panel`, `publication_shap_waterfall_local_explanation_panel`, `publication_shap_force_like_summary_panel` |
...
- Ranked feature-attribution summary, multi-panel dependence explanation, patient-level additive waterfall paths, and bounded force-like representative-case summaries under controlled point geometry, shared colorbar governance, explicit zero-reference guides, directional positive/negative contribution lanes, and deterministic `baseline + contributions = prediction` reconciliation.

Authoritative contract:

- Input schemas: `shap_summary_inputs_v1`, `shap_dependence_panel_inputs_v1`, `shap_waterfall_local_explanation_panel_inputs_v1`, `shap_force_like_summary_panel_inputs_v1`
- Renderer family: `python`
- QC: `publication_shap_summary`, `publication_shap_dependence_panel`, `publication_shap_waterfall_local_explanation_panel`, `publication_shap_force_like_summary_panel`
...
- lower-bound focus: panel-feature uniqueness, finite point coordinates, zero-line containment, shared colorbar governance, panel-label anchoring, contribution direction consistency, positive/negative lane containment, prediction-marker directionality, and deterministic `baseline + contributions = prediction` reconciliation for manuscript-facing local explanation panels
