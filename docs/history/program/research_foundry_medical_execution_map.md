...
- 对应的 blocker package 见 `../../policies/runtime-governance/external_runtime_dependency_gate.md`
...
当前与 runtime / eval / outer-loop artifact 一起冻结的 repo-tracked canonical bridge，见 `../../runtime/contracts/delivery_plane_contract_map.md`。
