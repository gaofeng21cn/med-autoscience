...
- `src/med_autoscience/controllers/owner_route_handoff/export_study_projection.py`：从 `controller_decisions.readiness_next_action` 投影 `current_owner_action.surface_key`。
- `src/med_autoscience/controllers/owner_route_handoff/default_executor_dispatch_tasks.py`：把 readiness `surface_key` 纳入 default-executor `readiness_surface_identity`、`source_fingerprint` 与 `dedupe_key`。
- `src/med_autoscience/controllers/domain_action_request_materializer.py` 与 `src/med_autoscience/controllers/domain_action_request_materializer/supervisor_request_packets.py`：把 readiness `readiness_surface_identity` 写入 supervisor request task / handoff packet。
...
```bash
rtk git diff --check -- docs/active/mas-ideal-state-gap-plan.md docs/history/program/README.md docs/history/program/medical_paper_readiness_surface_currentness_ssot_closeout_2026_06_06.md src/med_autoscience/controllers/domain_action_request_materializer.py src/med_autoscience/controllers/domain_action_request_materializer/supervisor_request_packets.py src/med_autoscience/controllers/domain_owner_action_dispatch_parts/action_execution/medical_paper_readiness.py src/med_autoscience/controllers/owner_route_handoff/default_executor_dispatch_tasks.py tests/domain_action_request_materializer_cases/test_stage_artifact_publication_handoff.py tests/test_cli_cases/owner_route_handoff_command_cases/default_executor_dispatch_currentness_cases.py tests/test_domain_owner_action_dispatch_cases/medical_paper_readiness_dispatch.py
rtk rg -n "^(<<<<<<<|=======|>>>>>>>)" docs/active/mas-ideal-state-gap-plan.md docs/history/program/README.md docs/history/program/medical_paper_readiness_surface_currentness_ssot_closeout_2026_06_06.md src/med_autoscience/controllers/domain_action_request_materializer.py src/med_autoscience/controllers/domain_action_request_materializer/supervisor_request_packets.py src/med_autoscience/controllers/domain_owner_action_dispatch_parts/action_execution/medical_paper_readiness.py src/med_autoscience/controllers/owner_route_handoff/default_executor_dispatch_tasks.py tests/domain_action_request_materializer_cases/test_stage_artifact_publication_handoff.py tests/test_cli_cases/owner_route_handoff_command_cases/default_executor_dispatch_currentness_cases.py tests/test_domain_owner_action_dispatch_cases/medical_paper_readiness_dispatch.py
