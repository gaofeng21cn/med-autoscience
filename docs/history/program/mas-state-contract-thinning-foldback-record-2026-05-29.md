...
Current owner note: 本文已退出 active 层，只作为 history/provenance 读取。当前控制面行为契约回到 `docs/status.md`、`docs/active/mas-ideal-state-gap-plan.md`、runtime projection docs、contracts/source 和 focused tests。
...
| [Study truth kernel](../../runtime/projections/study_truth_kernel.md) | 定义当前 body-free truth projection 与 false-authority boundary。 |
