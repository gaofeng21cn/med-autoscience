...
本文件是 MAS 吸收 MDS 的总执行计划；[Runtime Lifecycle SQLite Migration Program](../../active/runtime_lifecycle_sqlite_migration_program.md) 是本计划下的 runtime persistence / quest Git retirement 子计划，不是另一条独立并行路线。
