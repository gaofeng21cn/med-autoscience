...
### 2026-05-27 program history no-resurrection coverage tranche

本轮覆盖 MAS `docs/history/program/**` 历史/provenance cluster。目标是让旧 program boards、Hermes-first cutover/activation packages、Research Foundry / Domain Harness OS execution maps、journal package checkbox plan、P2 runtime-retirement program、learning intake snapshots、full records 和 closeout ledgers 保留审计价值，同时避免 dated “当前”“默认”“activation rule”“next step”“P2”“required sub-skill”“checkbox” 被误读成今天的 active execution queue、default runtime topology、runnable CLI truth、publication/artifact authority 或 production readiness。本轮不关闭全局 `/goal`，也不表示 MAS repo-wide README/docs 覆盖完成。

Live truth inputs:

- MAS `AGENTS.md`, `TASTE.md`, `docs/status.md`, `docs/invariants.md`, `docs/active/mas-ideal-state-gap-plan.md`, `docs/docs_portfolio_consolidation.md`, `docs/references/positioning/mas_ideal_state.md`, `docs/runtime/contracts/runtime_boundary.md`, and this docs-governance ledger.
- Target docs: all 34 Markdown files under `docs/history/program/`.
- Program index: `docs/history/program/README.md`, which already classifies learning intakes, closeouts / activation records, and superseded boards / plans.
- Doctor preflight from `/Users/gaofeng/workspace/opl-doc-governance/scripts/opl_doc_doctor.py`, used only as structural risk map.

Fresh semantic result:

- Current MAS truth remains `Declarative Medical Research Pack + OPL generated/hosted surfaces + minimal medical authority functions`. Hosted autonomous runtime defaults to OPL/Temporal; `Codex CLI` is the default stage executor; MAS owns study truth, AI reviewer / auditor quality gates, publication route, artifact authority, memory decision, owner receipts and typed blockers.
- `docs/history/program/README.md` already works as a history index: it points current program governance to active owner docs and classifies old learning intake snapshots, closeout records, activation packages and superseded boards. No body edit was needed.
- `hermes_backend_activation_package.md`, `hermes_backend_continuation_board.md`, and `upstream_hermes_agent_fast_cutover_board.md` now carry first-screen read rules so Hermes-first default-substrate / activation / cutover language cannot override current OPL/Temporal default runtime and explicit non-default executor/proof/provenance role.
- `research_foundry_medical_mainline.md`, `research_foundry_medical_execution_map.md`, and `open_harness_os_freeze_plan.md` now mark Research Foundry / Domain Harness OS / Open Harness OS phase and freeze wording as historical. Current target state and execution order must come from the active MAS plan, core docs, contracts and live read-model.
- `journal_package_builtins_upgrade_plan.md` now marks its required sub-skill, checkbox implementation plan and old file list as historical implementation provenance. Current journal/submission target and artifact authority truth remains in active plan, contracts, source and focused tests.
- `opl_temporal_mas_runtime_retirement_program.md` now explicitly reads as P2 framework-transition history/provenance rather than a second active plan, and its stale relative link to the active MAS ideal-state gap plan now points to `../../active/mas-ideal-state-gap-plan.md`.
...
| Repo | Reviewed docs / sections | Edited docs this tranche |
| --- | --- | --- |
| `med-autoscience` | Full paragraph read of all 34 `docs/history/program/*.md` files, with supporting current-boundary read of MAS active truth, status, invariants, docs portfolio governance, ideal-state reference and runtime boundary. | `docs/history/program/hermes_backend_activation_package.md`; `docs/history/program/hermes_backend_continuation_board.md`; `docs/history/program/upstream_hermes_agent_fast_cutover_board.md`; `docs/history/program/research_foundry_medical_mainline.md`; `docs/history/program/research_foundry_medical_execution_map.md`; `docs/history/program/journal_package_builtins_upgrade_plan.md`; `docs/history/program/opl_temporal_mas_runtime_retirement_program.md`; `docs/history/program/open_harness_os_freeze_plan.md`; this coverage ledger. |
| `one-person-lab` | OPL family ledger foldback for this MAS history tranche. | `docs/active/development-document-portfolio.md` |

Exact MAS history paths newly recorded by this tranche: `docs/history/program/README.md`; `docs/history/program/ai_first_closeout_handoff_governance.md`; `docs/history/program/ai_first_operationalization_closeout.md`; `docs/history/program/ai_first_paper_autonomy_closure_program_2026_05_10_full_record.md`; `docs/history/program/ai_first_usable_closeout_projection.md`; `docs/history/program/deepscientist_learning_intake_2026_04_25.md`; `docs/history/program/deepscientist_learning_intake_2026_04_28.md`; `docs/history/program/deepscientist_learning_intake_2026_04_30.md`; `docs/history/program/deepscientist_learning_intake_2026_05_05.md`; `docs/history/program/deepscientist_learning_intake_2026_05_08.md`; `docs/history/program/docs_lifecycle_audit_2026_05_17.md`; `docs/history/program/docs_lifecycle_governance_closeout_2026_05_20.md`; `docs/history/program/external_agent_orchestration_learning_intake_2026_04_30.md`; `docs/history/program/hermes_backend_activation_package.md`; `docs/history/program/hermes_backend_continuation_board.md`; `docs/history/program/integration_harness_activation_package.md`; `docs/history/program/journal_package_builtins_upgrade_plan.md`; `docs/history/program/mas-standard-agent-doc-process-history-2026-05.md`; `docs/history/program/mas_mds_autonomy_operating_system_program.md`; `docs/history/program/mas_mds_unified_enhancement_program.md`; `docs/history/program/mas_single_project_mds_absorb_program_2026_05_10_full_record.md`; `docs/history/program/open_auto_research_learning_intake_2026_05_04.md`; `docs/history/program/open_harness_os_freeze_plan.md`; `docs/history/program/opl_app_mas_runtime_workbench_program_2026_05_11_full_record.md`; `docs/history/program/opl_temporal_mas_runtime_retirement_program.md`; `docs/history/program/opl_temporal_mas_runtime_retirement_program_2026_05_11_full_record.md`; `docs/history/program/paper_orchestra_learning_intake_2026_05_02.md`; `docs/history/program/plan_completion_ledger.md`; `docs/history/program/real_study_relaunch_verification.md`; `docs/history/program/research_foundry_medical_execution_map.md`; `docs/history/program/research_foundry_medical_mainline.md`; `docs/history/program/research_harness_learning_intake_2026_05_11.md`; `docs/history/program/runtime_lifecycle_sqlite_migration_program_2026_05_08_full_record.md`; `docs/history/program/upstream_hermes_agent_fast_cutover_board.md`.

Archived / tombstoned / deleted docs:

- none. The program cluster remains useful history/provenance and no-resurrection guard material; stale current-surface risk was corrected with first-screen read rules and one link fix.

Unreviewed docs:

- `docs/history/program/**` now has no exact uncovered Markdown path in this cluster after this tranche.
- MAS repo-wide `README*` and `docs/**/*.md` full paragraph coverage remains open outside prior focused MAS chunks and this program-history tranche. Remaining exact uncovered clusters are `docs/history/superpowers/**` and remaining history directory indexes.
- OPL series coverage outside MAS remains open per the OPL family coverage ledger; App full-doc coverage remains delayed while active release / GUI lanes are safe or explicitly assigned.

Remaining stale / retire candidates:

- Future MAS prose that treats old Hermes-first activation/cutover, Research Foundry / Domain Harness OS phase ladders, Open Harness OS freeze status, journal package checkbox plans, old P2 lanes, learning intake snapshots or full-record checklists as current active queue, default runtime owner, runnable CLI truth, publication/artifact authority, domain-ready or production-ready evidence is stale pollution.
- Future runtime/program prose must keep OPL/Temporal as default hosted runtime owner, `Codex CLI` as stage executor, and Hermes / MDS / DeepScientist / Research Foundry vocabulary in explicit adapter/proof/provenance/history roles unless live contracts/source/tests prove a new active owner.
- Remaining MAS history coverage should focus on `docs/history/superpowers/**` and history directory indexes, then reconcile exact inventory against the coverage ledger.
...
### 2026-05-27 superpowers history no-resurrection coverage tranche

本轮覆盖 MAS `docs/history/superpowers/**` 历史/provenance cluster。目标是让 repo-tracked Superpowers plan / spec 草稿保留可审计 design / plan provenance，同时避免正文中的 REQUIRED SUB-SKILL、checkbox、File Structure、旧 CLI/MCP/runtime/workspace 路径、DeepScientist/MDS/Hermes 默认口径、绝对路径或当时的 current/default 表述被误读成今天的 active execution queue、current CLI truth、runtime owner、regression oracle、publication/artifact authority 或 production readiness。本轮不关闭全局 `/goal`，也不表示 MAS repo-wide README/docs 覆盖完成。

Live truth inputs:

- MAS `AGENTS.md`, `TASTE.md`, `docs/status.md`, `docs/invariants.md`, `docs/active/mas-ideal-state-gap-plan.md`, `docs/docs_portfolio_consolidation.md`, and this docs-governance ledger.
- Target docs: all 47 Markdown files under `docs/history/superpowers/`.
- Directory index: `docs/history/superpowers/README.md`, which already marks this cluster as historical repo-tracked Superpowers process drafts.
- Doctor preflight from `/Users/gaofeng/workspace/opl-doc-governance/scripts/opl_doc_doctor.py`, used only as structural risk map.

Fresh semantic result:

- Current MAS truth remains `Declarative Medical Research Pack + OPL generated/hosted surfaces + minimal authority functions`; OPL/Temporal owns hosted autonomous runtime, stage attempt, queue, wakeup, retry/dead-letter, attempt ledger and worker residency; `Codex CLI` is the default stage executor; MAS owns study truth, AI reviewer / auditor quality gates, publication route, artifact authority, memory decision, owner receipts and typed blockers.
...
| Repo | Reviewed docs / sections | Edited docs this tranche |
| --- | --- | --- |
| `med-autoscience` | Full paragraph / first-screen read of all 47 `docs/history/superpowers/**/*.md` files, with supporting current-boundary read of MAS active truth, status, invariants and docs portfolio governance. | `docs/history/superpowers/README.md`; all `docs/history/superpowers/plans/*.md`; all `docs/history/superpowers/specs/*.md`; this coverage ledger. |
| `one-person-lab` | OPL family ledger foldback for this MAS history tranche. | `docs/active/development-document-portfolio.md` |

Exact MAS history paths newly recorded by this tranche: `docs/history/superpowers/README.md`; `docs/history/superpowers/plans/2026-03-29-data-assets-layer.md`; `docs/history/superpowers/plans/2026-03-29-deepscientist-adapter-decoupling.md`; `docs/history/superpowers/plans/2026-03-29-medical-overlay-frontload.md`; `docs/history/superpowers/plans/2026-03-29-medical-overlay-installer.md`; `docs/history/superpowers/plans/2026-03-29-quest-reference-paper-contract.md`; `docs/history/superpowers/plans/2026-03-29-readme-branding-plan.md`; `docs/history/superpowers/plans/2026-03-29-research-route-bias-and-archetypes.md`; `docs/history/superpowers/plans/2026-03-29-submission-targets-and-journal-resolution.md`; `docs/history/superpowers/plans/2026-03-29-workspace-entry-and-delivery-compat.md`; `docs/history/superpowers/plans/2026-03-30-controller-first-and-automation-ready.md`; `docs/history/superpowers/plans/2026-03-30-disease-workspace-model.md`; `docs/history/superpowers/plans/2026-03-30-external-deepscientist-workspace-phase1.md`; `docs/history/superpowers/plans/2026-03-30-external-research-optional-module.md`; `docs/history/superpowers/plans/2026-03-30-init-workspace-mcp-exposure.md`; `docs/history/superpowers/plans/2026-03-30-init-workspace.md`; `docs/history/superpowers/plans/2026-03-30-journal-shortlist-boundary-implementation.md`; `docs/history/superpowers/plans/2026-03-30-portfolio-research-memory-implementation.md`; `docs/history/superpowers/plans/2026-03-30-sidecar-provider-and-figure-sidecar.md`; `docs/history/superpowers/plans/2026-03-30-third-party-agent-entry-implementation.md`; `docs/history/superpowers/plans/2026-03-31-deepscientist-compatibility-shield.md`; `docs/history/superpowers/plans/2026-03-31-figure-surface-rectification.md`; `docs/history/superpowers/plans/2026-03-31-remove-autofigure-branch.md`; `docs/history/superpowers/plans/2026-04-01-med-deepscientist-authority-cleanup.md`; `docs/history/superpowers/plans/2026-04-01-meddeepscientist-docs-baseline-intake.md`; `docs/history/superpowers/plans/2026-04-02-one-person-lab-repo-bootstrap.md`; `docs/history/superpowers/plans/2026-04-02-opl-banner-layout-repair.md`; `docs/history/superpowers/plans/2026-04-02-runtime-boundary-convergence.md`; `docs/history/superpowers/plans/2026-04-02-runtime-protocol-round2.md`; `docs/history/superpowers/plans/2026-04-03-medical-display-surface-phase2-evidence-materialization.md`; `docs/history/superpowers/plans/2026-04-05-ci-soft-preflight.md`; `docs/history/superpowers/specs/2026-03-29-aris-sidecar-design.md`; `docs/history/superpowers/specs/2026-03-29-quest-reference-paper-contract-design.md`; `docs/history/superpowers/specs/2026-03-29-readme-branding-design.md`; `docs/history/superpowers/specs/2026-03-29-workspace-entry-and-legacy-compat-design.md`; `docs/history/superpowers/specs/2026-03-30-disease-workspace-model-design.md`; `docs/history/superpowers/specs/2026-03-30-external-research-optional-module-design.md`; `docs/history/superpowers/specs/2026-03-30-init-workspace-design.md`; `docs/history/superpowers/specs/2026-03-30-init-workspace-mcp-exposure-design.md`; `docs/history/superpowers/specs/2026-03-30-journal-shortlist-boundary-design.md`; `docs/history/superpowers/specs/2026-03-30-portfolio-research-memory-design.md`; `docs/history/superpowers/specs/2026-03-30-sidecar-provider-and-figure-sidecar-design.md`; `docs/history/superpowers/specs/2026-03-30-third-party-agent-entry-design.md`; `docs/history/superpowers/specs/2026-04-02-one-person-lab-blueprint-design.md`; `docs/history/superpowers/specs/2026-04-05-ci-soft-preflight-design.md`; `docs/history/superpowers/specs/2026-04-06-medical-display-taxonomy-unification-design.md`; `docs/history/superpowers/specs/2026-04-08-managed-runtime-user-notice-design.md`.

Archived / tombstoned / deleted docs:

- none. The cluster remains useful history/provenance and no-resurrection guard material; stale current-surface risk was corrected with directory-level and first-screen read rules.

Unreviewed docs:

- `docs/history/superpowers/**` now has no exact uncovered Markdown path in this cluster after this tranche.
- MAS repo-wide `README*` and `docs/**/*.md` full paragraph coverage remains open outside prior focused MAS chunks and this superpowers-history tranche. Remaining exact uncovered scope is now primarily remaining history directory indexes and any exact inventory items not yet reconciled against the ledger.
- OPL series coverage outside MAS remains open per the OPL family coverage ledger; App full-doc coverage remains delayed while active release / GUI lanes are safe or explicitly assigned.
...
- Future active work must start from active owner docs, core docs, contracts, source, tests, runtime/controller surfaces, owner receipts and live read-model, not from these history drafts.
- Remaining MAS history coverage should reconcile leftover directory indexes and exact inventory against the coverage ledger.
