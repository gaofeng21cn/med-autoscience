...
| Package/ScholarSkills 闭包 | `done` | 100% | MAS `0.2.11`、ScholarSkills exact lock `0.2.3`（range `>=0.2.0 <0.3.0`）、required capability ABI 与两个 package-owned Connect adapter modules |
