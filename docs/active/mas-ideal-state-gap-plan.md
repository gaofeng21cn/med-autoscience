...
| MDS / DeepScientist | 只作为 source provenance、historical fixture、explicit archive import、backend audit、upstream learning、smoothness learning 和 parity oracle reference。可吸收经验是单循环、少默认门、持续产出和 UI 体感；它不回到 MAS 默认 backend、quality owner、artifact authority 或 runtime owner。 |
