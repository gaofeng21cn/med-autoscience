...
| Package / ScholarSkills dependency | `contracts/opl_agent_package_manifest.json` 声明 MAS SemVer `0.2.14`、硬依赖范围 `>=0.2.0 <0.3.0` 和 required ABI/exports/modules | exact installed resolution、lock 与 activation 归 OPL package readback |
