...
| Domain owner evidence shape | `shape_landed_scaleout_pending` | guarded apply、owner-route、aftercare、body-free evidence packet、typed blocker shape 与 OPL owner-payload group return shapes 已可供 OPL refs-only ledger 消费；真实 paper-line owner receipt / reviewer record / artifact movement 仍需扩面。 |
