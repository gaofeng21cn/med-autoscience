...
| B002 / B003 论文优先恢复 | [B002 / B003 论文优先恢复运行规则](./b002_b003_paper_first_recovery_runbook.md) | 当前 DM002/DM003 paper-first 运行规则：governed MAS/OPL path 优先；若 governed path 被 handoff/authorization/currentness 阻塞，切 foreground paper sprint，先产出可审阅论文工作品或 owner decision packet。 |
