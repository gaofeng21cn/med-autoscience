...
2. 下一轮真正论文推进必须从 canary readback 进入 study workspace artifact delta 或 owner decision packet 物化，并由 MAS authority consume/route-back/human-gate/typed-blocker surface 处理。
