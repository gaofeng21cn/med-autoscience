...
- `MedDeepScientist` is now a frozen source archive, historical fixture, explicit legacy diagnostic, and provenance/parity reference; MAS remains the only research, runtime, progress, quality, and publication owner.
