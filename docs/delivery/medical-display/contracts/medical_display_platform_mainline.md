...
Machine boundary: 当前 MAS 机器入口是 `contracts/capability_map.json`、Stage manifest/quality policy、ScholarSkills `medical-display-core` canonical catalog refs 与 OPL hosted receipts。
