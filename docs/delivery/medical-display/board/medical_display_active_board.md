...
- 以及仅在 template inventory 真相变化后需要同步的 ScholarSkills `canonical_template_catalog.json`、`medical_display_arsenal.md`、`medical_display_audit_guide.md`、`medical_display_family_roadmap.md`；历史扩充账本只在追加 provenance 时更新：`docs/history/capabilities/medical-display/medical_display_arsenal_history.md`
