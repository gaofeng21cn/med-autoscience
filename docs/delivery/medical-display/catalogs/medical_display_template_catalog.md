...
| `fenggaolab.org.medical-display-core::center_transportability_governance_summary_panel` | `evidence_figure` | `A. Predictive Performance and Decision`, `H. Cohort and Study Design Evidence` | Center Transportability Governance Summary Panel | `r_ggplot2` | `center_transportability_governance_summary_panel_inputs_v1` | `publication_center_transportability_governance_summary_panel` | `png`, `pdf` | `validated_summary_required` / `validated_display_payload` |
...
- Required nested collection fields: None
- Optional nested collection fields: None
- Additional constraints: `centers_must_contain_at_least_two_items`, `center_ids_must_be_unique`, `center_labels_must_be_unique`, `support_counts_must_be_positive`, `event_counts_must_be_non_negative`, `metric_values_must_be_finite`, `center_metric_intervals_must_satisfy_lower_le_estimate_le_upper`, `acceptance_thresholds_must_be_finite`
