...
| Recipe | Hero panel |
| --- | --- |
| `clinical_triptych_prediction` | primary_model_performance_summary |
| `model_validation_dashboard` | validation_summary_or_generalizability |
| `schematic_led_composite` | schematic_or_process_hero |
| `image_plate_plus_quantification` | representative_image_plate |
| `asymmetric_genomics_figure` | dominant_molecular_pattern |
| `single_cell_atlas_storyboard` | cell_state_geometry_or_spatial_context |
