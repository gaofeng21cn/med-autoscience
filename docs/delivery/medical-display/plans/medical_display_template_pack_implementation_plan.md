...
- `docs/delivery/medical-display/catalogs/medical_display_template_catalog.md`
  - 改为从活动模板包真相重新生成。
- `docs/delivery/medical-display/catalogs/medical_display_arsenal.md`
  - 军火库总账新增“当前内置核心包”口径。
- `docs/histo../delivery/medical-display/medical_display_arsenal_history.md`
...
- Modify: `src/med_autoscience/controllers/display_surface_materialization.py`
- Modify: `tests/test_display_surface_materialization.py`
- Modify: `docs/delivery/medical-display/catalogs/medical_display_template_catalog.md`
- Modify: `docs/delivery/medical-display/catalogs/medical_display_arsenal.md`
- Modify: `docs/histo../delivery/medical-display/medical_display_arsenal_history.md`
...
Path("docs/delivery/medical-display/catalogs/medical_display_template_catalog.md").write_text(
...
```text
docs/delivery/medical-display/catalogs/medical_display_template_catalog.md regenerated
```
...
4. 当前 `docs/delivery/medical-display/catalogs/medical_display_template_catalog.md` 已由包化真相重新生成。
