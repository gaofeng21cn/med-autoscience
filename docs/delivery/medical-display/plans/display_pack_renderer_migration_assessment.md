...
Machine boundary: 本文是人读结构评估。机器真相继续归 ScholarSkills `packs/medical-display-core/**` descriptor / template source、renderer source、`renderer_migration_ledger.json`、E2E runtime、tests、真实 paper artifacts、visual-audit receipt、owner receipt 和 publication gate。
