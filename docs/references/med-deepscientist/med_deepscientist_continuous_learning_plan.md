...
- [MAS Single-Project Quality And Autonomy Mainline](../mainline/mas_single_project_quality_and_autonomy_mainline.md)
...
2. `domain_diagnostic_report -> outer-loop wakeup -> controller decision` 如何成为统一治理链
