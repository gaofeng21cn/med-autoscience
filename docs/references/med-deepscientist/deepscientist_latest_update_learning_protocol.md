...
- `MAS`: `docs/status.md`
- `MAS`: `docs/active/mas-ideal-state-gap-plan.md`
- `MAS`: `docs/policies/runtime-governance/mas_mds_owner_boundary_contract.md` and `docs/history/program/mas_single_project_mds_absorb_guard_2026_06_07.md`
