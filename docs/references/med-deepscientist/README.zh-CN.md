...
本目录保存 MDS 学习、解构、upstream intake、provenance 和迁移期参考材料。
...
这些是参考材料，不是独立 program board。当前执行队列以 [Program portfolio consolidation](../../program/program_portfolio_consolidation.md) 为准。
