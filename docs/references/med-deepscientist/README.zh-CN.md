...
这些是参考材料，不是独立 program board。当前执行队列以 [Program portfolio consolidation](../../program/program_portfolio_consolidation.md) 为准，学习入口以 [DeepScientist latest-update learning protocol](./deepscientist_latest_update_learning_protocol.md) 为准。
