...
| supervision cadence | `purpose_equivalent_with_different_timing` | Use MAS supervision scheduler contract; default adapter is 300s MAS local one-shot tick, with Hermes gateway cron as explicit optional adapter. |
