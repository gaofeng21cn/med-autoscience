...
| [med-deepscientist](./med-deepscientist/README.zh-CN.md) | 上游学习、provenance、method 和 deconstruction 参考。 |
...
- [MAS 理想目标态](./positioning/mas_ideal_state.zh-CN.md)：MAS 作为医学研究 domain agent 的 north-star 目标边界，以及它与 OPL、workspace、runtime artifact、quality gate、memory 和 workbench 的理想分工。
