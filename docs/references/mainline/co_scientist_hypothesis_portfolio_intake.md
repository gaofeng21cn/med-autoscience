...
原 Stage / Route 重构规格已经落入 `agent/` semantic pack、Stage manifest、quality
contracts 与 OPL refs-only projection；当前扩展直接修改这些 owner surfaces，不再维护
一份已完成设计稿作为第二 source of truth。
