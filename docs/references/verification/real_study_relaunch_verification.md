...
- [`../../history/program/integration_harness_activation_package.md`](../../history/program/integration_harness_activation_package.md) 所定义的 `Phase 6 / Integration Harness And Cutover Readiness`
