...
from .authority_boundary import (
    admission_gate_false_boundary_fields as _admission_gate_false_boundary_fields,
    attach_non_read_only_invocation_gate_fields as _attach_non_read_only_invocation_gate_fields,
    executor_receipt_ref_policy as _executor_receipt_ref_policy,
    non_read_only_authority_boundary_fields as _non_read_only_authority_boundary_fields,
    non_read_only_gate as _non_read_only_gate,
)
...
from . import schemas as arsenal_schemas
...
def build_agent_tool_arsenal_index(
    ...
    return {
        ...
        "tool_index_refs": {
            ...
            "mcp_registry": "src/med_autoscience/mcp_server/tool_registry.py",
            "owner_callable_registry": (
