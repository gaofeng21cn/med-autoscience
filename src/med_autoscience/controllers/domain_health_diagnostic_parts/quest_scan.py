...
def run_domain_health_diagnostic_for_quest(
    *,
    ...
    for name, runner in iter_ordered_controller_runners(controller_runners):
        ...
        previous = controller_state.get(name) or domain_health_diagnostic_protocol.DomainHealthDiagnosticControllerState()
        ...
        plan = domain_health_diagnostic_protocol.plan_controller_intervention(
        ...
        if plan.should_apply:
            ...
            controller_state[name] = domain_health_diagnostic_protocol.DomainHealthDiagnosticControllerState(
