...
from med_autoscience.controllers.workspace_init.shell_rendering import (
...
from med_autoscience.controllers.workspace_init.legacy_entries import legacy_managed_runtime_entry_reason
from med_autoscience.controllers.workspace_init.profile_config import (
...
def _rendered_files(
    *,
    ...
    files = [
        ...
        RenderedFile(
            path=workspace_root / "ops" / "medautoscience" / "bin" / "study-progress",
            content=_render_study_progress_script(),
            executable=True,
        ),
        RenderedFile(
