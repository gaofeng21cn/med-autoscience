...
def _controller_events(profile_payload: Mapping[str, Any]) -> dict[str, Any]:
    ...
    dedupe_summary = dict(_mapping(profile_payload.get("domain_diagnostic_wakeup_dedupe_summary")))
    ...
    return {
        ...
        "domain_diagnostic_wakeup_dedupe_summary": dedupe_summary,
    }
...
def _stuck_at(*, gate_assessment: Mapping[str, Any], controller_events: Mapping[str, Any]) -> str:
    ...
    if primary_gate == "opl_handoff_gate":
        return "domain_diagnostic_report"
