...
def _provider_admission_identity(
    ...
    *,
    ...
    result_projection = _mapping(candidate.get("opl_domain_progress_transition_result"))
    result_identity = _mapping(result_projection.get("identity"))
    result_stage_identity = _mapping(result_projection.get("stage_run_identity"))
    result_causality = _mapping(result_projection.get("causality"))

    study_id = (
        _text(candidate.get("study_id"))
        or _text(request_identity.get("study_id"))
        or _text(result_identity.get("study_id"))
    ...
    work_unit_fingerprint = (
        ...
        or _text(result_identity.get("work_unit_fingerprint"))
    ...
    route_identity_key = (
        ...
        or _text(result_identity.get("route_identity_key"))
        or _text(result_stage_identity.get("route_identity_key"))
    ...
    attempt_idempotency_key = (
        ...
        or _text(result_identity.get("attempt_idempotency_key"))
        or _text(result_stage_identity.get("attempt_idempotency_key"))
    ...
    return {
        ...
        "work_unit_id": (
            ...
            or _text(result_identity.get("work_unit_id"))
        ...
        "request_idempotency_key": (
            ...
            or _text(result_causality.get("mas_transition_request_idempotency_key"))
            or _text(result_identity.get("request_idempotency_key"))
            or _text(result_identity.get("attempt_idempotency_key"))
