...
from .validation_stratified_display import (
...
_VALIDATOR_BY_SCHEMA_ID: dict[str, _EvidenceDisplayValidator] = {
    ...
    "stratified_mismatch_matrix_inputs_v1": _validate_stratified_mismatch_matrix_display_payload,
    ...
    "transition_support_matrix_inputs_v1": _validate_transition_support_matrix_display_payload,
    ...
    "stratified_mismatch_burden_inputs_v1": _validate_stratified_mismatch_burden_display_payload,
}
