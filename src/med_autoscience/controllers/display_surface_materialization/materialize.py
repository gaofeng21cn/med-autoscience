...
from .materialize_parts.workspace import _active_generated_illustration_paths_from_catalog, _claim_ids_for_table, _is_known_requirement_key, _load_display_shell_payload, _purpose_first_renderer_fields, _resolve_contract_backed_figure_contract_path, _resolve_requirement_key_from_shell, _resolve_workspace_path
