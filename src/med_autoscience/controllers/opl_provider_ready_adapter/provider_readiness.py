    ...
    if proven:
        ...
        return {
            ...
            "semantics": {
                ...
                "provider_completion_is_paper_closure": False,
                "paper_closure_requires_mas_owner_receipt": True,
                "mas_domain_diagnostic_report_role": "domain_truth_and_local_diagnostics",
            },
        }
    return {
