...
def _prompt_contract_ref(prompt_contract: Mapping[str, Any]) -> dict[str, Any] | None:
    ...
    ref = {
        ...
        "owner_callable_target": _text(prompt_contract.get("owner_callable_target")),
        "owner_callable_request": _mapping(prompt_contract.get("owner_callable_request")) or None,
