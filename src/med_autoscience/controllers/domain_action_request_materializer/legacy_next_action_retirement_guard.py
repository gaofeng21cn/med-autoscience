...
from med_autoscience.controllers.domain_action_request_materializer import current_action_queue
...
def next_action_identity_mismatches(action: Mapping[str, Any]) -> bool:
    ...
    if next_action_type is not None and action_type is not None and next_action_type != action_type:
        return True
    next_work_unit = _work_unit_id(next_action.get("work_unit_id"))
