...
DUPLICATION_RISK_CLASSES: tuple[dict[str, Any], ...] = (
    {
        ...
        "trigger": "study_progress, workspace-cockpit, product-frontdesk, MCP, or product-entry starts deciding next action independently",
...
REPAIR_PROGRAM = (
    ...
    },
    {
        ...
        "status": "active",
        "description": "Keep study_progress, workspace-cockpit, product-frontdesk, product-entry, and MCP as thin projections.",
