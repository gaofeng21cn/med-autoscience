...
_FUNCTIONAL_MODULE_INVENTORY = (
    ...
    },
    {
        ...
        "latest_thinning_evidence": {
            "status": "runtime_storage_cache_cleanup_shell_split",
            "scope": "delete_safe_cache_scan_apply_shell",
            "extracted_paths": [
                "src/med_autoscience/controllers/runtime_storage_maintenance_parts/cache_cleanup.py",
            ],
            "retained_entry_shell": "src/med_autoscience/controllers/runtime_storage_maintenance.py",
            "retained_entry_role": "workspace_storage_refs_and_runtime_audit_entry",
    ...
    },
    {
        ...
        "code_paths": [
            ...
            "src/med_autoscience/controllers/runtime_live_console_ui_parts/constants.py",
            "src/med_autoscience/controllers/runtime_live_console_ui_parts/html.py",
            "src/med_autoscience/controllers/runtime_live_console_ui_parts/payload.py",
            "src/med_autoscience/controllers/runtime_live_console_ui_parts/rendering.py",
            "src/med_autoscience/controllers/runtime_live_console_ui_parts/shared.py",
        ],
        "latest_thinning_evidence": {
            "status": "live_console_ui_payload_and_html_shell_split",
            "retained_entry_shell": "src/med_autoscience/controllers/runtime_live_console_ui.py",
            "extracted_paths": [
                "src/med_autoscience/controllers/runtime_live_console_ui_parts/constants.py",
                "src/med_autoscience/controllers/runtime_live_console_ui_parts/html.py",
                "src/med_autoscience/controllers/runtime_live_console_ui_parts/payload.py",
            ...
            "does_not_claim_opl_default_caller": True,
            "does_not_claim_physical_delete": True,
            "does_not_touch_study_truth_publication_quality_or_package_authority": True,
        },
