...
def quality_repair_action(
    *,
    ...
    return {
        ...
        "summary": (
            "The current quality repair batch is blocked until the write owner produces a "
        ...
        "quality_repair_batch_ref": _text(route.get("quality_repair_batch_path")),
