...
def resolve_domain_route_scan_study_ids(profile: WorkspaceProfile) -> tuple[str, ...]:
...
def validate_scan_domain_routes_study_ids(profile: WorkspaceProfile, study_ids: tuple[str, ...]) -> None:
    available_study_ids = set(resolve_domain_route_scan_study_ids(profile))
...
__all__ = ["resolve_domain_route_scan_study_ids", "validate_scan_domain_routes_study_ids"]
