    ...
    *,
    ...
    action_fingerprints = {
        ...
        for value in (
            ...
            _text(_mapping(action.get("repair_progress_precedence")).get("work_unit_fingerprint")),
            _text(_mapping(action.get("repair_progress_precedence")).get("action_fingerprint")),
        )
