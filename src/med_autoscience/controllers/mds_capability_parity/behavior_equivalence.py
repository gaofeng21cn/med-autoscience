...
from med_autoscience.controllers.mds_capability_parity.paper_progress_degradation import (
...
BEHAVIOR_EQUIVALENCE_SURFACES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "behavior_difference": "MAS now exposes per-study refs-only progress projections and stable study ids for OPL hosted workbench consumption. Runtime conversation and portal-console soak read models are physically retired from MAS so OPL current_control_state remains the only operator runtime surface.",
        "default_user_impact": "Users can inspect MAS progress through OPL hosted workbench without running MDS WebUI; runtime conversation, terminal, and live execution drilldown must come from OPL current_control_state or provider attempt projection.",
        "mas_contract": "OPL hosted workbench consumes MAS payload refs, freshness, source refs, artifact locators, owner receipts, typed blockers, and route decision refs without reinterpreting study truth, runtime truth, or medical quality.",
        "future_parity_candidate": "opl_app_current_control_state_user_path_soak",
        "recommended_operator_action": "use_opl_hosted_workbench",
    },
    {
        ...
        "mas_behavior": {
            "opl_hosted_workbench": "default progress and blocker entry",
        ...
        "default_user_impact": "Users use OPL hosted workbench for paper/domain progress and OPL runtime surfaces for terminal/log/provider drilldown.",
    ...
    },
    {
        ...
        "mas_behavior": {
            ...
            "opl_stage_folder_state_index_refs": True,
            "publication_route_memory_closeout": True,
            "publication_route_memory_acceptance_receipt": True,
            "opl_state_index_refs": True,
        ...
        "mas_contract": "opl_stage_folder_state_index_refs, publication_route_memory_closeout, publication_route_memory_acceptance_receipt, opl_state_index_refs, memory/portfolio/research_memory, canonical literature, reference context, evidence/review ledgers, and controller decisions share authority by owner boundary.",
