...
PUBLICATION_WORK_UNIT_REPAIR_IDS = {
    ...
    "medical_prose_write_repair": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
    ...
    "dm002_medical_prose_write_repair_after_quality_batch": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
    ...
    "dm002_same_line_publication_paper_repair": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
    ...
    "dm002_current_publication_hardening_after_ai_reviewer_eval": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
    ...
    "dm002_current_manuscript_reporting_consistency_write_repair": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
    ...
    "dm002_current_manuscript_methods_model_reporting_and_package_currentness_write_pass": frozenset(
        {
            "repair_paper_live_paths",
            "workspace_display_repair_script",
            "sync_publication_shell_surface",
