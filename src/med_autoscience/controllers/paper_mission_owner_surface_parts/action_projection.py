...
from med_autoscience.controllers.paper_mission_owner_surface_parts import analysis_harmonization_ai_review
from med_autoscience.controllers.paper_mission_owner_surface_parts import artifact_freshness
from med_autoscience.controllers.paper_mission_owner_surface_parts import ai_reviewer_actions
from med_autoscience.controllers.paper_mission_owner_surface_parts import completion_evidence
from med_autoscience.controllers.paper_mission_owner_surface_parts import controller_followthrough_actions
from med_autoscience.controllers.paper_mission_owner_surface_parts import current_controller_followthrough
from med_autoscience.controllers.paper_mission_owner_surface_parts import current_ai_reviewer_record_actions
from med_autoscience.controllers.paper_mission_owner_surface_parts import currentness_preemption_actions
...
from med_autoscience.controllers.paper_mission_owner_surface_parts import parked_truth
from med_autoscience.controllers.paper_mission_owner_surface_parts import recovery_actions
...
def action_queue(
    ...
    *,
    ...
    if gate_specificity.get("required") is True:
        from med_autoscience.controllers.paper_mission_owner_surface_parts import publication_gate_actions
...
def _higher_priority_owner_truth_blocks_pending_ai_reviewer_request(
    *,
    ...
    if _consumed_ai_reviewer_routeback_domain_transition(status) and not repair_progress_followup.pending_ai_reviewer_recheck_consumes_current_write_routeback(
        study_root=study_root,
        publication_eval_payload=publication_eval_payload,
    ):
        return True
...
def _higher_priority_owner_truth_blocks_shared(
    *,
    ...
    if current_truth_owner.current_story_surface_delta_blocker_route(
        study_root=study_root,
        publication_eval_payload=publication_eval_payload,
    ) and not repair_progress_followup.pending_ai_reviewer_recheck_consumes_current_write_routeback(
        study_root=study_root,
        publication_eval_payload=publication_eval_payload,
    ):
        return True
