...
from .projection_payload_assembly.typed_blocker_resolution_successor import (
...
from .projection_existing_refresh import (
    refresh_existing_projection_current_owner_surfaces as _refresh_existing_projection_current_owner_surfaces_impl,
...
def _refresh_existing_projection_current_owner_surfaces(**kwargs: Any) -> dict[str, Any]:
    return _refresh_existing_projection_current_owner_surfaces_impl(
        **kwargs,
...
def build_study_progress_projection(
    *,
    ...
    runtime_readback_report_path = input_paths.runtime_readback_report_path
    ...
    runtime_readback_payload = surface_payloads.runtime_readback_payload
    ...
    latest_events = _latest_events(
        ...
        runtime_readback_payload=runtime_readback_payload,
        runtime_readback_report_path=runtime_readback_report_path,
        details_projection_payload=details_projection_payload,
    ...
    research_runtime_control_projection = _research_runtime_control_projection(
        ...
        runtime_readback_report_ref=str(runtime_readback_report_path) if runtime_readback_report_path is not None else None,
    )
