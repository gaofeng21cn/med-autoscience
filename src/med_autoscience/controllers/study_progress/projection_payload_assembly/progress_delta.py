...
from med_autoscience.controllers.study_progress.shared import (
    _mapping_copy,
    _non_empty_text,
)
...
def progress_delta_metrics(
    *,
    ...
    paper_tokens = _delta_tokens(total_tokens=total_tokens, triggered=paper_triggered)
    platform_tokens = total_tokens if platform_triggered else _inactive_platform_tokens(
        total_tokens=total_tokens,
        paper_triggered=paper_triggered,
    )
    deliverable_delta = {
