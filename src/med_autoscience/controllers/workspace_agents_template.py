...
def render_workspace_agents(*, workspace_name: str) -> str:
    return (
        ...
        "- `runtime/` 是运行态目录，`runtime/artifacts/` 是 SQLite refs index 与维护 ledger，`ops/medautoscience/` 是唯一 MAS workspace ops 入口；`ops/mas/progress/` 只作 Progress Portal 静态只读投影。\n\n"
        "## 用户论文修改请求处理\n\n"
