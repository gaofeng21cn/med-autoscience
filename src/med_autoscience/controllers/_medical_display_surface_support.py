...
_REQUIRED_DISPLAY_SURFACE_STUBS: dict[str, RequiredDisplaySurfaceStub] = {
    ...
    "phenotype_gap_structure_figure": RequiredDisplaySurfaceStub(
        filename="dpcc_phenotype_gap_structure.json",
        blocker_key="missing_dpcc_phenotype_gap_structure",
        stub_kind="display_inputs",
        schema_key="input_schema_id",
        schema_value="dpcc_phenotype_gap_structure_v1",
    ...
    "site_held_out_stability_figure": RequiredDisplaySurfaceStub(
        filename="dpcc_transition_site_support.json",
        blocker_key="missing_dpcc_transition_site_support",
        stub_kind="display_inputs",
        schema_key="input_schema_id",
        schema_value="dpcc_transition_site_support_v1",
        status="required_pending_materialization",
    ...
    "treatment_gap_alignment_figure": RequiredDisplaySurfaceStub(
        filename="dpcc_treatment_gap_alignment.json",
        blocker_key="missing_dpcc_treatment_gap_alignment",
        stub_kind="display_inputs",
        schema_key="input_schema_id",
        schema_value="dpcc_treatment_gap_alignment_v1",
        status="required_pending_materialization",
