...
from med_autoscience.controllers.stage_artifact_index.authority_projection import (
...
from med_autoscience.controllers.stage_artifact_index.contract_refs import (
    contract_ref_set as _contract_ref_set,
    manifest_declared_support_refs as _manifest_declared_support_refs,
)
from med_autoscience.controllers.stage_artifact_index.legacy_taxonomy import (
...
from med_autoscience.controllers.stage_artifact_index.text_helpers import (
...
_PAPER_STUDY_STAGE_PACK_ROOT = Path(__file__).resolve().parents[4]
