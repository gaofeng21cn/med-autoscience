...
from med_autoscience.controllers.provider_admission.provider_admission_current_control import (
...
from med_autoscience.controllers.provider_admission.provider_admission_report_closeout_identity import (
...
from med_autoscience.controllers.provider_admission.provider_admission_report_closeout_scan import (
...
from med_autoscience.controllers.provider_admission.provider_admission_report_current_action_identity import (
    candidate_with_current_action_identity as _candidate_with_current_action_identity,
)
from med_autoscience.controllers.provider_admission.provider_admission_report_same_tick_materialize import (
    provider_admission_candidates_from_same_tick_materialize as _provider_admission_candidates_from_same_tick_materialize,
)
from med_autoscience.controllers.provider_admission.provider_admission_report_runtime_surfaces import (
    sync_current_control_runtime_surfaces as _sync_current_control_runtime_surfaces,
)
from med_autoscience.controllers.provider_admission.provider_admission_report_terminal_consumed import (
...
from med_autoscience.controllers.provider_admission.provider_admission_report_transition_filters import (
    filter_transition_requests_consumed_by_currentness as _filter_transition_requests_consumed_by_currentness,
)
...
from med_autoscience.controllers.provider_admission.provider_admission_report_readback_filters import (
...
from med_autoscience.controllers.owner_route_handoff.accepted_owner_gate_route_back import (
...
def sync_report_provider_admission_current_control_state(
    ...
    *,
    ...
    terminal_consumed_by_study = _terminal_consumed_by_study(current_control_state)
    synced_actions = _sync_managed_action_provider_admission_candidates(
        ...
        terminal_consumed_by_study=terminal_consumed_by_study,
    )
    ...
    if terminal_consumed_by_study:
        current_execution_evidence["progress_currentness"] = _sync_progress_currentness_terminal_consumed(
            current_execution_evidence.get("progress_currentness"),
            terminal_consumed_by_study=terminal_consumed_by_study,
        )
        _sync_report_paper_recovery_states_from_actions(
            report,
