...
def build_gate_report(state: GateState) -> dict[str, Any]:
    ...
    submission_minimal_authority = (
        _describe_submission_minimal_authority(
...
def _describe_submission_minimal_authority(**kwargs: Any) -> dict[str, Any]:
    from med_autoscience.controllers.submission_minimal.authority import (
        describe_submission_minimal_authority,
    )

    return describe_submission_minimal_authority(**kwargs)
