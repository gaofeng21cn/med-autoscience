...
def _request_task_ref_projection(
    ...
    *,
    ...
    request_ref = {
        ...
        "evidence_gap_decision_summary": _mapping(payload.get("evidence_gap_decision_summary")) or None,
        "evidence_gap_typed_blocker_count": payload.get("evidence_gap_typed_blocker_count"),
        "current_action_can_continue": payload.get("current_action_can_continue"),
