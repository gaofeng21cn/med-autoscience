...
def validate_supervisor_scan_study_ids(profile: WorkspaceProfile, study_ids: tuple[str, ...]) -> None:
...
__all__ = ["resolve_supervisor_scan_study_ids", "validate_supervisor_scan_study_ids"]
