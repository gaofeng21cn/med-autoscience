...
from med_autoscience.controllers.product_entry.paper_orchestra_operator import (
    build_workspace_paper_orchestra_operator_projection,
)

from med_autoscience.controllers.product_entry.workspace_cockpit.readiness_and_delivery import (
...
from med_autoscience.controllers.product_entry.workspace_cockpit.state_and_study_items import (
