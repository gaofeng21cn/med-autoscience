...
def build_study_progress_projection(**kwargs: Any) -> dict[str, Any]:
    from med_autoscience.controllers.study_progress.projection import (
        build_study_progress_projection as _build_study_progress_projection,
    )

    return _build_study_progress_projection(**kwargs)
