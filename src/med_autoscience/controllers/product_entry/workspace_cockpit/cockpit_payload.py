...
from med_autoscience.controllers.product_entry import shared as _shared
from med_autoscience.controllers.product_entry.workspace_cockpit import (
    state_and_study_items as _state_and_study_items,
)
from med_autoscience.controllers.product_entry.workspace_cockpit.command_assembly import (
    study_commands,
    user_loop_commands,
    workspace_commands,
)
from med_autoscience.controllers.product_entry.workspace_cockpit.attention_hub import (
    attention_queue as build_attention_queue,
    operator_brief as build_operator_brief,
)
from med_autoscience.controllers.product_entry.workspace_cockpit.health_cards import (
    workspace_health_cards,
)
from med_autoscience.controllers.product_entry.workspace_cockpit.progress_projection import (
