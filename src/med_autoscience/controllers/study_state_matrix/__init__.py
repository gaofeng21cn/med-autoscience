...
from med_autoscience.controllers.study_state_matrix.current_owner_handoff import (
...
def build_study_state_matrix(
    *,
    ...
    return {
        ...
        "counts": counts,
        "progress_first_tick_accounting": progress_first_tick_accounting(monitoring_summaries),
        "studies": studies,
...
def _progress_first_monitoring_summary(
    *,
    ...
    stale_redrive_blocker_superseded = redrive_budget_blocker_superseded_by_terminal_delta(existing)
    if stale_redrive_blocker_superseded:
        existing = {
            **existing,
            "execution_state_kind": "executable_owner_action",
            "typed_blocker": None,
            "current_blockers": current_blockers_without_redrive_budget(existing),
            "stale_typed_blocker_resolution": {
                "status": "superseded",
