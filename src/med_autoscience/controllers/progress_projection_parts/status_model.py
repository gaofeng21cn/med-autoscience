...
@dataclass
class ProgressProjectionStatus(MutableMapping[str, Any]):
    schema_version: int
    study_id: str
    study_root: str
    entry_mode: str
    ...
    @classmethod
    def from_payload(cls, payload: dict[str, Any]) -> "ProgressProjectionStatus":
    ...
    def _normalize_study_completion_state_field(
        ...
        *,
        ...
        resolved_study_root = (
            Path(ProgressProjectionStatus._normalize_path_field("study_root", study_root))
