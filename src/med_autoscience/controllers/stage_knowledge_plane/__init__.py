...
from med_autoscience.controllers.stage_knowledge_plane.publication_route_memory_writeback import sync_accepted_publication_route_memory_cards as _sync_route_memory_cards
...
def build_paper_soak_memory_apply_proof(
    *,
    ...
    route_memory_refs = stage_packet.get("publication_route_memory_refs") or select_publication_route_memory_refs(
        workspace_root=resolved_workspace_root,
        stage=resolved_stage,
    )
    return _build_paper_soak_memory_apply_proof_projection(
        study_id=study_id,
        stage=resolved_stage,
        study_root=resolved_study_root,
        workspace_root=resolved_workspace_root,
        stage_packet_path=stage_packet_path,
        publication_route_memory_pack_root=publication_route_memory_pack_root(
            workspace_root=resolved_workspace_root
        ),
