    ...
    entries.extend(
        [
            ...
            (
                ...
                'medical_overlay_skills = ["intake-audit", "scout", "baseline", "idea", "decision", "experiment", "analysis-campaign", "figure", "write", "review", "external-scientific-skills", "rebuttal", "finalize"]',
            ),
