...
from med_autoscience.controllers.provider_admission_parts.provider_admission_current_control_weak_identity import (
...
def provider_admission_current_control_study(candidate: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "action_queue": [action],
        "provider_admission_identity": provider_identity if provider_admission_pending else None,
        "provider_admission_identity_key": route_key if provider_admission_pending else None,
