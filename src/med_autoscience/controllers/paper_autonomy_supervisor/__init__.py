...
from med_autoscience.controllers.paper_autonomy_supervisor.policy_result_shape import (
    ALLOWED_DECISIONS,
    AUTHORITY_BOUNDARY,
...
def _decision(
    ...
    *,
    ...
    payload = {
        ...
        "legacy_surface_kind": LEGACY_DECISION_SURFACE_KIND,
        "legacy_decision_surface_kind": LEGACY_DECISION_SURFACE_KIND,
        "legacy_decision_field": decision,
