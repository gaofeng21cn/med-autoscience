...
def canonical_codex_app_automation_prompt() -> str:
    return "\n".join(
        [
            ...
            "先通过 MAS/OPL 维护的外层监督合同推进同 tick：supervisor-reconcile --mode developer_apply_safe --apply；supervisor-scan --apply-safe-actions --apply-runtime-platform-repair --developer-supervisor-mode developer_apply_safe；supervisor-consume --mode developer_apply_safe --apply；supervisor-execute-dispatch --mode developer_apply_safe --apply。",
