...
def resolve_paper_mission_owner_surface_study_ids(profile: WorkspaceProfile) -> tuple[str, ...]:
...
def validate_scan_paper_mission_owner_surface_study_ids(profile: WorkspaceProfile, study_ids: tuple[str, ...]) -> None:
    available_study_ids = set(resolve_paper_mission_owner_surface_study_ids(profile))
...
__all__ = ["resolve_paper_mission_owner_surface_study_ids", "validate_scan_paper_mission_owner_surface_study_ids"]
