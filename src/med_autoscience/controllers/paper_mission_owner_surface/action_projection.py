...
from med_autoscience.controllers.paper_mission_owner_surface import analysis_harmonization_ai_review
...
from med_autoscience.controllers.paper_mission_owner_surface import current_controller_followthrough
from med_autoscience.controllers.paper_mission_owner_surface import current_ai_reviewer_record_actions
from med_autoscience.controllers.paper_mission_owner_surface import currentness_preemption_actions
...
from med_autoscience.controllers.paper_mission_owner_surface import recovery_actions
from med_autoscience.controllers.paper_mission_owner_surface import repair_progress_followup
from med_autoscience.controllers.paper_mission_owner_surface import runtime_facts
from med_autoscience.controllers.paper_mission_owner_surface import story_surface_delta_actions
...
def _legacy_action_queue(
    ...
    *,
    ...
    if gate_specificity.get("required") is True:
        from med_autoscience.controllers.paper_mission_owner_surface import publication_gate_actions
