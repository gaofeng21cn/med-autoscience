...
BEHAVIOR_EQUIVALENCE_SURFACES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "mas_behavior": {
            ...
            "conversation_read_model": "landed_read_only",
            "portal_console_soak_user_parity_keys": True,
        },
        "behavior_difference": "MAS now has per-study Progress Portal pages, stable study deep links, a read-only route/decision trail helper, conversation read model, and soak evidence keys, but full old-WebUI UX parity still needs real-workspace polish and interactive control/terminal attach gates.",
        "default_user_impact": "Users can inspect MAS progress without running MDS WebUI and can enter a single-study workbench; final WebUI user parity remains evidence-gated by real workspace soak and interactive safety gates.",
    ...
    },
    {
        ...
        "mas_behavior": {
            ...
            "authorized_portal_actions": "controller_receipt_only",
