...
BEHAVIOR_EQUIVALENCE_SURFACES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "mas_behavior": {
            ...
            "stream_transport": "SSE snapshot/loopback stream, not MDS WebSocket attach",
            "websocket_terminal_attach": False,
            "bash_log_streaming": "read-only terminal/log tail refs",
        },
        "behavior_difference": "MAS preserves the observation purpose through Progress Portal plus Live Console, but does not revive the old resident MDS WebSocket terminal attach.",
        "default_user_impact": "Users now have MAS-owned progress and read-only live observation surfaces; low-latency interactive daemon console control remains outside default MAS operation.",
