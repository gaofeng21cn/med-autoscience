...
def currentness_identity(progress: Mapping[str, Any]) -> dict[str, Any]:
    ...
    currentness_basis = _mapping(next_action.get("currentness_basis"))
    source_refs = {
        key: value
        for key, value in {
            ...
            "work_unit_fingerprint": (
                ...
                or _text(next_action.get("work_unit_fingerprint"))
                or _text(next_action.get("action_fingerprint"))
    ...
    return {
        ...
        for key, value in {
            "action_type": (
                ...
                or _text(next_action.get("action_type"))
            ),
...
def work_unit_id(progress: Mapping[str, Any]) -> str | None:
    ...
    return (
        ...
        or _work_unit_id(next_action.get("work_unit_id"))
