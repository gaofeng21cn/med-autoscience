...
def _append_generated_file(*args: Any, **kwargs: Any) -> None:
    from .current_package_projection import _append_generated_file as impl

    return impl(*args, **kwargs)


def _copy_current_package_audit_surfaces(*args: Any, **kwargs: Any) -> tuple[dict[str, Any], Path]:
    from .current_package_projection import _copy_current_package_audit_surfaces as impl

    return impl(*args, **kwargs)


def _source_signature_payload_from_manifest(*args: Any, **kwargs: Any) -> dict[str, Any]:
    from .current_package_projection import _source_signature_payload_from_manifest as impl

    return impl(*args, **kwargs)


def _write_current_package_reproducibility_documents(*args: Any, **kwargs: Any) -> None:
    from .current_package_projection import _write_current_package_reproducibility_documents as impl

    return impl(*args, **kwargs)


def sync_current_package_projection(*args: Any, **kwargs: Any) -> dict[str, Any]:
    from .current_package_projection import sync_current_package_projection as impl
