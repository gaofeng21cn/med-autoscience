...
def merge_live_attempt_observability_into_handoff(
    *,
    ...
    if live_attempt_running:
        merged = _bind_live_attempt_to_handoff_identity(
            handoff=merged,
            live_attempt_handoff=live_attempt_handoff,
        )
...
def _bind_live_attempt_to_handoff_identity(
    *,
    ...
    if identity is None:
        return merged
    for key in ("action_type", "work_unit_id", "work_unit_fingerprint", "action_fingerprint"):
