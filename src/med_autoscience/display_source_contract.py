...
INPUT_FILENAME_BY_SCHEMA_ID: dict[str, str] = {
    ...
    "stratified_mismatch_matrix_inputs_v1": "stratified_mismatch_matrix_inputs.json",
    ...
    "transition_support_matrix_inputs_v1": "transition_support_matrix_inputs.json",
    "radar_profile_inputs_v1": "radar_profile_inputs.json",
    "waterfall_response_inputs_v1": "waterfall_response_inputs.json",
    "stratified_mismatch_burden_inputs_v1": "stratified_mismatch_burden_inputs.json",
