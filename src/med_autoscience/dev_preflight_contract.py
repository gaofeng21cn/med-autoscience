...
_DOC_ONLY_EXACT_PATHS = (
    ...
    "docs/history/program/mas_mds_unified_enhancement_program.md",
    ...
    "docs/policies/repository_ci_preflight.md",
    ...
    "docs/references/med-deepscientist/upstream_intake.md",
