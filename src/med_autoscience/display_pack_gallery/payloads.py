...
MANUAL_GALLERY_DISPLAY_PAYLOADS: dict[str, dict[str, Any]] = {
    ...
    "submission_graphical_abstract": {
        ...
        "caption": "Illustrative, non-quantitative graphical-abstract composition.",
        ...
        "panels": [
            {
                ...
                "rows": [{"cards": [{"card_id": "population_message", "title": "Stage message", "value": "Patient profiles", "accent_role": "primary"}]}],
            },
            {
                ...
                "rows": [{"cards": [{"card_id": "finding_message", "title": "Stage message", "value": "Risk gradient", "accent_role": "contrast"}]}],
            },
            {
                ...
                "rows": [{"cards": [{"card_id": "meaning_message", "title": "Stage message", "value": "Matched follow-up", "accent_role": "secondary"}]}],
            },
        ],
        "footer_pills": [],
    },
...
GALLERY_R_DISPLAY_PAYLOADS: dict[str, dict[str, Any]] = {
    "phenotype_gap_structure_figure": {
        ...
        "title": "Risk-profile composition and care-mismatch structure",
        "caption": "Synthetic preview of group composition paired with denominator-defined mismatch rates.",
        "composition_panel_title": "Profile share",
        "heatmap_panel_title": "Mismatch pattern",
        "heatmap_scale_label": "Mismatch rate",
        "metric_definitions": [
            {"metric_id": "indicator_a", "metric_label": "Indicator A"},
            {"metric_id": "indicator_b", "metric_label": "Indicator B"},
            {"metric_id": "indicator_c", "metric_label": "Indicator C"},
            {"metric_id": "indicator_d", "metric_label": "Indicator D"},
        ],
        "rows": [
            {
                ...
                "group_share": 0.34,
                "metrics": [
                    {"metric_id": "indicator_a", "value": 0.72},
                    {"metric_id": "indicator_b", "value": 0.48},
                    {"metric_id": "indicator_c", "value": 0.58},
                    {"metric_id": "indicator_d", "value": 0.66},
                ],
            },
            {
                "group_label": "Mixed-risk profile",
                "group_share": 0.29,
                "metrics": [
                    {"metric_id": "indicator_a", "value": 0.18},
                    {"metric_id": "indicator_b", "value": 0.22},
                    {"metric_id": "indicator_c", "value": 0.64},
                    {"metric_id": "indicator_d", "value": 0.59},
                ],
            },
            {
                ...
                "group_share": 0.37,
                "metrics": [
                    {"metric_id": "indicator_a", "value": None},
                    {"metric_id": "indicator_b", "value": 0.12},
                    {"metric_id": "indicator_c", "value": 0.16},
                    {"metric_id": "indicator_d", "value": 0.21},
                ],
            },
        ],
    ...
    "site_held_out_stability_figure": {
        ...
        "title": "Profile transition stability and held-out support",
        "caption": "Synthetic preview of transition shares paired with held-out support distribution.",
        "transition_panel_title": "Profile transition support",
        "support_panel_title": "Held-out support",
        "heatmap_scale_label": "Transition share",
        "transition_rows": [
            {
                "source_group_label": "Higher-risk profile",
                "target_group_label": "Higher-risk profile",
                "unit_count": 420,
                "transition_share": 0.46,
            },
            {
                "source_group_label": "Higher-risk profile",
                "target_group_label": "Mixed-risk profile",
                "unit_count": 210,
                "transition_share": 0.23,
            },
            {
                "source_group_label": "Lower-risk profile",
                "target_group_label": "Higher-risk profile",
                "unit_count": 180,
                "transition_share": 0.20,
            },
            {
                "source_group_label": "Lower-risk profile",
                "target_group_label": "Lower-risk profile",
                "unit_count": 100,
                "transition_share": 0.11,
            },
        ],
        "support_rows": [
            {"support_label": "Held-out group 1", "unit_count": 320, "support_share": 0.35},
            {"support_label": "Held-out group 2", "unit_count": 280, "support_share": 0.31},
            {"support_label": "Held-out group 3", "unit_count": 305, "support_share": 0.34},
        ],
        "render_context": {"layout_override": {"output_width_in": 7.2, "output_height_in": 3.8}},
    },
    "treatment_gap_alignment_figure": {
        ...
        "title": "Stratified care-mismatch burden",
        "caption": "Synthetic preview of denominator-defined mismatch burden across clinical profiles.",
        ...
        "rows": [
            {
                ...
                "group_size": 1000,
                "metrics": [
                    {"metric_id": "indicator_a", "event_count": 720, "denominator": 1000},
                    {"metric_id": "indicator_b", "event_count": 480, "denominator": 1000},
                    {"metric_id": "indicator_c", "event_count": 580, "denominator": 1000},
                    {"metric_id": "indicator_d", "event_count": 660, "denominator": 1000},
                ],
            },
            {
                "group_label": "Mixed-risk profile",
                "group_size": 850,
                "metrics": [
                    {"metric_id": "indicator_a", "event_count": 153, "denominator": 850},
                    {"metric_id": "indicator_b", "event_count": 187, "denominator": 850},
                    {"metric_id": "indicator_c", "event_count": 544, "denominator": 850},
                    {"metric_id": "indicator_d", "event_count": 502, "denominator": 850},
                ],
            },
            {
                "group_label": "Lower-risk profile",
                "group_size": 800,
                "metrics": [
                    {"metric_id": "indicator_a", "event_count": 0, "denominator": 800},
                    {"metric_id": "indicator_b", "event_count": 96, "denominator": 800},
                    {"metric_id": "indicator_c", "event_count": 128, "denominator": 800},
                    {"metric_id": "indicator_d", "event_count": 168, "denominator": 800},
                ],
            },
        ],
