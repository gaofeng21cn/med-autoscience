...
def _collect_source_provenance(
    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "source_owner": record.source_config.source_owner,
        "source_ref": record.source_config.source_ref,
        "source_version": record.source_config.source_version,
        "source_role": record.source_config.source_role,
        "source_authority": record.source_config.source_authority,
        "fallback": record.source_config.fallback,
