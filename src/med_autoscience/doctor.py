...
def render_doctor_report(report: DoctorReport) -> str:
    lines = [
        ...
        f"legacy_diagnostic_runtime_root: {report.profile.med_deepscientist_runtime_root}",
        ...
        f"legacy_diagnostic_runtime_exists: {str(report.med_deepscientist_runtime_exists).lower()}",
...
def render_profile(profile: WorkspaceProfile) -> str:
    lines = [
        ...
        f"legacy_diagnostic_runtime_root: {profile.med_deepscientist_runtime_root}",
