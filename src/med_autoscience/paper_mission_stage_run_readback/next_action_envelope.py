...
def paper_mission_next_action_envelope(
    *,
    ...
    opl_stage_run_context: Mapping[str, Any] | None = None,
    ...
    route = _first_mapping(
        _mapping(ai_route_context),
        _mapping(handoff.get("ai_route_context")),
        _mapping(transaction_payload.get("ai_route_context")),
    )
    carrier = _first_mapping(
        _mapping(opl_stage_run_context),
        _mapping(handoff.get("opl_stage_run_context")),
    )
    ...
    route_ref = _first_text(
        ...
        carrier.get("ai_route_context_ref"),
        f"{transaction_ref}#ai_route_context" if transaction_ref else None,
    )
...
def attach_paper_mission_next_action(
    ...
    *,
    ...
    envelope = paper_mission_next_action_envelope(
        ...
        ai_route_context=_mapping(result.get("ai_route_context")),
        opl_stage_run_context=_mapping(result.get("opl_stage_run_context")),
