...
from med_autoscience.paper_mission_stage_run_readback.receipt_events import (
    ...
    first_opl_stage_attempt_receipt as _first_opl_stage_attempt_receipt,
...
def _stage_attempt_closeout(
    *,
    ...
    if _non_current_closeout_reason(blocked_reason):
        return None
    stage_attempt_receipt = _first_opl_stage_attempt_receipt(carrier, packet, attempt)
    if stage_attempt_receipt is None:
        return None
    if _text(stage_attempt_receipt.get("stage_attempt_id")) != stage_attempt_id:
        return None
    ...
    return {
        ...
        "typed_blocker_ref": _first_text(
            ...
            stage_attempt_receipt.get("typed_runtime_blocker_ref"),
        ),
        "blocked_reason": blocked_reason,
        "closeout_refs": closeout_refs,
        "opl_stage_attempt_receipt": stage_attempt_receipt,
        **(
