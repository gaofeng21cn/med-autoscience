...
from .receipt_events import (
    ...
    matches_opl_stage_attempt_receipt as _matches_opl_stage_attempt_receipt,
)
...
from .runtime_readback_payloads import (
    ...
    opl_stage_attempt_receipt_readback as _opl_stage_attempt_receipt_readback,
...
WAITING_READBACK_STATUS = "optional_stage_attempt_readback_missing"
def paper_mission_stage_run_context_readback(
    *,
    ...
    if matched is None:
        return {
            ...
            "runtime_readback_status": "optional_transport_readback_missing",
            "dispatch_status": _text(carrier.get("dispatch_status"))
            or "ai_route_context_available",
            "domain_ready_verdict": "quality_debt_transport_evidence_missing",
            "provider_completion_is_domain_completion": False,
            "provider_completion_is_domain_ready": False,
            ...
            "quality_debt": ["optional_stage_attempt_transport_readback_missing"],
        }
    ...
    opl_stage_attempt_receipt = _opl_stage_attempt_receipt_readback(
        closeout=closeout,
        closeout_ref=closeout_ref,
        carrier=carrier,
    )
...
def attach_opl_stage_attempt_readback(
    *,
    ...
    carrier = _mapping(result.get("opl_stage_run_context"))
    if not carrier:
        return result
    ...
    result["opl_stage_attempt_readback"] = carrier_readback
    result["opl_stage_attempt_readback_status"] = carrier_readback["carrier_status"]
    return result
