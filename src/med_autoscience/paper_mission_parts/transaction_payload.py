...
from med_autoscience.paper_mission_parts.audit_pack import ref_kind
from med_autoscience.paper_mission_parts.authority_boundary import PAPER_AUDIT_PACK_FAMILIES
