...
_DISPLAY_SCHEMA_CLASSES: tuple[DisplaySchemaClass, ...] = (
    ...
    DisplaySchemaClass(
        ...
        input_schema_ids=("embedding_grouped_inputs_v1", "celltype_signature_heatmap_inputs_v1"),
    ),
    DisplaySchemaClass(
    ...
    DisplaySchemaClass(
        ...
        input_schema_ids=("shap_summary_inputs_v1", "shap_dependence_panel_inputs_v1"),
    ),
    DisplaySchemaClass(
