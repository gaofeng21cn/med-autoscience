...
MANUAL_GALLERY_DISPLAY_PAYLOADS: dict[str, dict[str, Any]] = {
    ...
    "submission_graphical_abstract": {
        ...
        "caption": "Brief-first, reference-guided, critic-gated graphical abstract workflow.",
        ...
        "panels": [
            {
                ...
                "title": "Figure brief",
                "subtitle": "Core claim and evidence chain before drawing",
                "rows": [{"cards": [{"card_id": "brief", "title": "Locked inputs", "value": "Brief", "evidence_token": "claim_refs", "detail": "refs only", "accent_role": "primary"}]}],
            },
            {
                ...
                "subtitle": "Journal family, layout cue, labels to preserve",
                "rows": [{"cards": [{"card_id": "reference", "title": "Style brief", "value": "Target", "evidence_token": "style_ref", "detail": "preserve list", "accent_role": "contrast"}]}],
            },
            {
                ...
                "subtitle": "Readability, source preservation, owner review",
                "rows": [{"cards": [{"card_id": "gate", "title": "Required refs", "value": "Review", "evidence_token": "critic_ref", "detail": "owner gate", "accent_role": "secondary"}]}],
            },
        ],
        "footer_pills": [
