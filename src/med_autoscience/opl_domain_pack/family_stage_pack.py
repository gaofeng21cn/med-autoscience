...
FAMILY_STAGE_PACK: tuple[dict[str, Any], ...] = (
    {
        ...
        "allowed_action_refs": ["study_progress", "study_state_matrix", "domain_handler_export"],
    ...
    },
    {
        ...
        "allowed_action_refs": ["study_progress", "domain_handler_export", "export_inspection_package"],
    ...
    },
    {
        ...
        "allowed_action_refs": ["study_progress", "domain_handler_export", "publication_aftercare_plan"],
