...
_REQUIRED_STYLE_ROLES_BY_TEMPLATE: dict[str, tuple[str, ...]] = {
    ...
    "decision_curve_binary": ("model_curve", "comparator_curve", "reference_line"),
    ...
    "roc_curve_binary": ("model_curve", "comparator_curve", "reference_line"),
    "pr_curve_binary": ("model_curve", "comparator_curve", "reference_line"),
    "calibration_curve_binary": ("model_curve", "comparator_curve", "reference_line"),
    "time_dependent_roc_horizon": ("model_curve", "comparator_curve", "reference_line"),
...
_DEFAULT_STYLE_PROFILE_PAYLOAD: dict[str, Any] = {
    ...
    "palette": {
        ...
        "neutral": "#13293D",
        "neutral_mid": "#64748B",
        "neutral_light": "#B7C4CC",
        "light": "#EEF4F7",
        "primary_soft": "#DCEBF0",
        "secondary_soft": "#F1DADA",
        "contrast_soft": "#DCE8F4",
        "tertiary_soft": "#F5E6C2",
        "quaternary_soft": "#DAF0EC",
        "violet_soft": "#E8E4F8",
        "audit": "#B2182B",
        "audit_soft": "#F3D7DA",
        "text": "#13293D",
        ...
        "background": "#FFFFFF",
        "muted": "#64748B",
        "heatmap_seq_low": "#EEF4F7",
        "heatmap_seq_mid": "#86BCC2",
        "heatmap_seq_high": "#245A6B",
        "heatmap_low": "#2166AC",
        "heatmap_mid": "#F7F7F7",
        "heatmap_high": "#B2182B",
        "volcano_up": "#B2182B",
        "volcano_down": "#2166AC",
        "volcano_background": "#B7C4CC"
    },
    "semantic_roles": {
        "model_curve": "primary",
