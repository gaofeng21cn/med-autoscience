    ...
    *,
    ...
    spec_type(
        ...
        exact_paths=(
            ...
            "tests/test_runtime_protocol_report_store.py",
        ...
        commands=(
            ...
            f"{pytest_clean_runner} tests/test_runtime_protocol_report_store.py -q",
            "make test-meta",
        ),
    ),
    spec_type(
    ...
    spec_type(
        ...
        exact_paths=(
            ...
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission.py",
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission_current_control.py",
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission_current_control_actions.py",
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission_current_control_arbiter.py",
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission_current_control_identity.py",
            "src/med_autoscience/controllers/provider_admission_parts/provider_admission_transition_request.py",
