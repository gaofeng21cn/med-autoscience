...
from med_autoscience.cli_parts.paper_mission_command_parts.drive_readback_parts.direct_next_action import (
...
from med_autoscience.cli_parts.paper_mission_command_parts.drive_readback_parts.followthrough import (
