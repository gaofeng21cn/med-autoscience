...
from .retention_commands import handle_retention_command
from .scientific_capability_registry_commands import (
    handle_scientific_capability_registry_command,
)
from .stage_memory_commands import handle_stage_memory_command
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command == "materialize-ai-reviewer-publication-eval":
        ...
        result = ai_reviewer_publication_eval.materialize_ai_reviewer_publication_eval(
            ...
            source="cli",
            build_production_trace=args.build_production_trace,
        )
        print(json.dumps(result, ensure_ascii=False, indent=2))
        return 0
