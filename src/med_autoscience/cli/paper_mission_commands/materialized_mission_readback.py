...
from med_autoscience.cli.paper_mission_commands.domain_transition_runtime_readback import (
...
from med_autoscience.cli.paper_mission_commands.materialized_owner_consumption import (
...
from med_autoscience.cli.paper_mission_commands.materialized_owner_repair_readback import (
    _owner_repair_receipt_consumption_readback,
    _owner_repair_receipt_is_newer,
    _stage_closure_ledger_readback_for_output,
)
from med_autoscience.cli.paper_mission_commands.one_shot_migration import (
    ONE_SHOT_MIGRATION_FORBIDDEN_AUTHORITY_WRITES,
)
from med_autoscience.cli.paper_mission_commands.projection_fields import (
...
from med_autoscience.cli.paper_mission_commands.readback_next_action_precedence import (
...
from med_autoscience.cli.paper_mission_commands.typed_blocker_resolution import (
        ...
        **(
            {
                "paper_mission_stage_closure_ledger_readback": (
                    stage_closure_ledger_readback_for_output
                )
            }
            if stage_closure_ledger_readback_for_output is not None
            else {}
        ),
        "consume_candidate_status": consume_candidate_status,
        "mutation_policy": {
