...
from med_autoscience.cli.paper_mission_commands.materialized_mission_readback import (
...
from med_autoscience.cli.paper_mission_commands.terminal_source_readback import (
...
def _build_paper_mission_readback(**kwargs: Any) -> dict[str, Any]:
    from med_autoscience.cli import paper_mission_commands
