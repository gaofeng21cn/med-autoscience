...
from med_autoscience.cli.evo_scientist_sidecar_commands import (
    register_evo_scientist_sidecar_parsers,
)
from med_autoscience.cli.current_owner_delta_owner_answer_commands import (
    register_current_owner_delta_owner_answer_parser,
)
from med_autoscience.cli.paper_mission_commands import register_paper_mission_parsers
from med_autoscience.cli.scientific_capability_registry_commands import (
    register_scientific_capability_registry_parser,
)
from med_autoscience.cli.study_action_commands import register_study_action_parsers
...
def build_parser(*, study_cycle_profiler) -> argparse.ArgumentParser:
    ...
    study_owner_gate_decision_parser.add_argument("--owner-gate-decision-ref")
    study_owner_gate_decision_parser.add_argument("--human-gate-ref")
    study_owner_gate_decision_parser.add_argument("--receipt-owner-consumption-ref")
    ...
    data_lifecycle_index_assets_parser = data_lifecycle_subparsers.add_parser("index-assets")
    data_lifecycle_index_assets_parser.add_argument("--workspace-root", required=True)
    data_lifecycle_index_assets_mode = data_lifecycle_index_assets_parser.add_mutually_exclusive_group(required=True)
    data_lifecycle_index_assets_mode.add_argument("--dry-run", action="store_true")
    data_lifecycle_index_assets_mode.add_argument("--apply", action="store_true")
    data_lifecycle_index_assets_parser.add_argument("--format", choices=("json",), default="json")
    data_lifecycle_compact_study_parser = data_lifecycle_subparsers.add_parser("compact-study")
    data_lifecycle_compact_study_parser.add_argument("--workspace-root", required=True)
    data_lifecycle_compact_study_mode = data_lifecycle_compact_study_parser.add_mutually_exclusive_group(required=True)
    data_lifecycle_compact_study_mode.add_argument("--dry-run", action="store_true")
    data_lifecycle_compact_study_mode.add_argument("--apply", action="store_true")
    data_lifecycle_compact_study_parser.add_argument("--format", choices=("json",), default="json")
    data_lifecycle_completed_project_parser = data_lifecycle_subparsers.add_parser("closeout-completed-project")
    data_lifecycle_completed_project_parser.add_argument("--workspace-root", required=True)
    data_lifecycle_completed_project_parser.add_argument("--project-id", required=True)
    data_lifecycle_completed_project_mode = data_lifecycle_completed_project_parser.add_mutually_exclusive_group(required=True)
    ...
    display_visual_audit_parser = subparsers.add_parser("materialize-display-visual-audit")
    display_visual_audit_parser.add_argument("--paper-root", required=True)
    ...
    ai_reviewer_record_parser.add_argument("--expected-work-unit-fingerprint", type=str)
