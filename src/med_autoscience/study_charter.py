...
DEFAULT_FIRST_DRAFT_QUALITY_CONTRACT = {
    ...
    "registry_observational_first_draft_floor": {
        "applies_to": [
            "registry_first_report",
            "descriptive_observational_registry",
            "phenotype_atlas",
        ],
        "required_before_submission_ready_claim": [
            "source_specific_enrollment_windows",
            "analytic_data_lock_date",
            "ethics_approval_consent_waiver_and_deidentification",
            "source_specific_inclusion_exclusion_flow",
            "variable_ascertainment_definitions_for_recorded_diagnostic_fields",
            "age_applicability_assessment_for_bmi_cutoffs",
            "adult_only_or_age_stratified_sensitivity_when_under_18_records_may_be_present",
            "availability_or_missingness_display_to_support_atlas_claim",
        ],
        "wording_guardrails": [
            "do_not_use_prevalence_or_burden_for_selected_available_diagnostic_fields",
            "prefer_recorded_or_populated_diagnostic_fields_when_denominator_is_field_available_records",
            "do_not_place_ethics_funding_coi_or_data_availability_as_limitations",
            "do_not_cite_prediction_reporting_guidelines_for_a_descriptive_registry_boundary_unless_the_study_has_a_modeling_component",
        ],
        "route_back_if_missing": "submission_blocker_human_gate_or_bounded_analysis_campaign_before_submission_package",
    },
