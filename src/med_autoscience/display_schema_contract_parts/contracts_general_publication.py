...
_INPUT_SCHEMA_CONTRACTS_GENERAL_PUBLICATION: tuple[InputSchemaContract, ...] = (
    ...
    InputSchemaContract(
        ...
        additional_constraints=(
            "centers_must_contain_at_least_two_items",
            "center_ids_must_be_unique",
            "center_labels_must_be_unique",
            "support_counts_must_be_positive",
            "event_counts_must_be_non_negative",
            "metric_values_must_be_finite",
            "center_metric_intervals_must_satisfy_lower_le_estimate_le_upper",
            "acceptance_thresholds_must_be_finite",
        ),
    ),
    InputSchemaContract(
