...
_INPUT_SCHEMA_CONTRACTS_DATA_GEOMETRY: tuple[InputSchemaContract, ...] = (
    InputSchemaContract(
        ...
        display_name="Precomputed Grouped Embedding Scatter",
        ...
        display_optional_fields=("paper_role", "embedding_input_mode"),
        collection_required_fields={"points": ("x", "y", "group")},
        additional_constraints=(
            "precomputed_coordinates_only_not_current_dimensionality_reduction_workflow",
    ...
    InputSchemaContract(
        ...
        display_kind="evidence_figure",
        display_name="Dimensionality Reduction Workflow",
        template_ids=_template_ids_for_input_schema("dimensionality_reduction_inputs_v1"),
        required_top_level_fields=("schema_version", "input_schema_id", "displays"),
        ...
        display_optional_fields=("paper_role", "source_feature_matrix_digest", "embedding_options", "points"),
        collection_required_fields={"feature_matrix": ("sample_id", "group", "features")},
        collection_optional_fields={"points": ("sample_id", "x", "y", "group")},
        additional_constraints=(
            "default_current_templates_compute_embedding_from_feature_matrix",
            "feature_matrix_must_be_non_empty",
            "feature_rows_must_have_same_named_numeric_features",
            "sample_groups_must_be_non_empty",
            "pca_uses_stats_prcomp",
            "tsne_requires_Rtsne_backend",
            "umap_requires_uwot_backend",
            "precomputed_points_allowed_only_when_embedding_input_mode_is_precomputed",
        ),
    ),
    InputSchemaContract(
