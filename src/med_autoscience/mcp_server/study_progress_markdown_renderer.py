...
from med_autoscience.mcp_server.open_auto_research_projection import render_mcp_open_auto_research_soak_markdown
from med_autoscience.mcp_server.opl_current_control_state_handoff_projection import render_mcp_progress_opl_current_control_state_handoff
from med_autoscience.mcp_server.study_progress_markdown_sections import render_mcp_progress_stage
