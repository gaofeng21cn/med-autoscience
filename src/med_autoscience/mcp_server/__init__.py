...
from .agent_tool_arsenal_handler import (
...
from .tool_registry import build_tool_registry, manifest_from_registry
...
def _serialize_study_runtime_result(result: dict[str, Any]) -> dict[str, Any]:
    from .projection_adapters import serialize_study_runtime_result
...
def _call_progress_projection(arguments: dict[str, Any]) -> dict[str, Any]:
    from .projection_adapters import render_progress_projection_result
...
def _call_open_auto_research_soak(arguments: dict[str, Any]) -> dict[str, Any]:
    from .projection_adapters import render_open_auto_research_soak_result
