...
MAS_AI_FIRST_RULES: tuple[DriftRule, ...] = (
    ...
    DriftRule(
        check_id="canonical_artifact_contract_forbids_current_package_authority",
        category="doctor_meta_test_surface",
        root_key="mas_repo_root",
        relative_path="src/med_autoscience/controllers/canonical_artifact_contract.py",
        summary="Artifact OS must rebuild from canonical sources and forbid current_package as authority.",
        required_markers=(
            ...
            '"study_charter_evidence_analysis_ai_review_sources"',
    ...
    DriftRule(
        check_id="quality_os_explains_auto_paper_and_analysis_discipline",
        category="doctor_meta_test_surface",
        root_key="mas_repo_root",
        relative_path="src/med_autoscience/controllers/medical_quality_operating_system.py",
        summary="The quality OS must explain the governed-paper chain and bounded analysis discipline.",
        required_markers=(
            '"medical_paper_as_governed_research_state_machine"',
            '"text_is_projection_not_authority": True',
            '"controlled_backend_oracle_intake_buffer"',
            '"research_creativity_and_route_choice_are_less_stable_than_governance"',
            '"archetype_specific_analysis_contract"',
            '"missingness"',
            '"sample_size_precision"',
            '"external_validation"',
            '"clinical_utility"',
            '"bounded_analysis_decision_contract"',
    ...
    DriftRule(
        check_id="target_journal_writing_layer_is_materialized_surface",
        category="doctor_meta_test_surface",
        root_key="mas_repo_root",
        relative_path="src/med_autoscience/policies/publication_critique.py",
        summary="Target journal writing fit must be a materialized AI reviewer context surface, not prose-only policy.",
        required_markers=(
            '"target_journal_writing_layer"',
            "TARGET_JOURNAL_WRITING_LAYER_RELATIVE_PATH",
    ...
    DriftRule(
        check_id="owner_route_context_is_nonbinding_and_currentness_scoped",
        category="owner_route_drift",
        root_key="mas_repo_root",
        relative_path="src/med_autoscience/controllers/stage_outcome_authority/owner_route_attempt_policy.py",
        summary="Owner-route context must remain nonbinding while exact currentness protects only the selected dispatch.",
        required_markers=(
