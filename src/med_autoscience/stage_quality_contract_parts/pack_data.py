...
_JOURNAL_EXTENSION_CONTRACTS: dict[str, tuple[dict[str, object], ...]] = {
    ...
    "figure_evidence_contract_pack": (
        ...
        {
            "contract_id": "scipilot_visualization_advisor_ref_floor",
            "learned_from": "Haojae/scipilot-figure-skill",
            "absorbed_as": "data_question_first_plot_selection_and_warning_refs",
            "required_fields": [
                "figure_question_or_core_claim",
                "variable_type_profile_ref",
                "group_sample_size_profile_ref",
                "plot_selection_rationale_ref",
                "misleading_chart_warning_ref",
                "deterministic_qc_ref",
                "ai_visual_review_ref",
            ],
            "forbidden_shortcuts": [
                "small_n_mean_bar_without_points",
                "dual_axis_without_shared_unit_or_scatter_rationale",
                "pie_or_3d_as_scientific_evidence",
                "rainbow_or_jet_for_ordered_scientific_data",
                "external_python_stack_as_default_mas_renderer",
            ],
            "typed_blocker_if_missing": "figure_selection_or_visual_qc_ref_missing_for_current_delta_only",
