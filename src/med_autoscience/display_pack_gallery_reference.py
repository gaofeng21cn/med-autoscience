...
这些 recipe 组织多个 evidence primitives，不是更多单图模板。PDF/HTML 会先展示 6 个页面级 storyboard，再展示 28 个 R/ggplot2 evidence primitive cards。
...
- canonical current R/ggplot2 evidence gallery cards: `{r_evidence_count}`
- current Python evidence templates: `0`
- Python design / flow shells in ggplot2 evidence Gallery: `0`
- rendered evidence primitive cards: `{rendered_count}`
...
- Nature-Skills figure learning head: `{nature_skills_head}`
