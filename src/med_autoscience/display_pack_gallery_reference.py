...
- [PDF 画册](./ggplot2_template_gallery.pdf)：面向人阅读的主文档，用于直观判断 MAS 默认图页组织、证据图起点和统一视觉风格。
...
PDF 画册分为两部分：前部展示 6 类页面级图页方案，后部展示 28 个 R/ggplot2 数据证据图起点。未证明优于 R/ggplot2 的 Python 数据证据模板不进入默认画册。
