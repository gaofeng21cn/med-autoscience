...
from med_autoscience.controllers.product_entry.boundary_surfaces import (
...
def test_build_product_entry_status_preflight_blocks_on_workspace_supervision_owner_drift(
    ...
    assert "legacy_gate_id" not in payload["family_orchestration"]["action_graph"]["human_gates"][0]
