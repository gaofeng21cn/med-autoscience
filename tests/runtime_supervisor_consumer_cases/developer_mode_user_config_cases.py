...
def test_supervisor_consume_allows_user_configured_developer_mode_without_github_owner(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_supervisor_consume_honors_user_config_disabled_over_apply_safe_default(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_consumer")
