...
from tests.test_gate_clearing_batch_cases.shared import _write_json, _write_text, importlib, make_profile
...
def test_submission_minimal_fingerprint_payload_ignores_materialized_submission_source_from_compile_report(
    ...
    submission_minimal_tests = importlib.import_module("tests.submission_minimal_cases.shared")
