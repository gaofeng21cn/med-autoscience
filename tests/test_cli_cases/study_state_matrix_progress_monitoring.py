...
def test_study_state_matrix_redrives_ai_reviewer_record_when_consumed_identity_differs(
    monkeypatch,
    tmp_path: Path,
    capsys,
) -> None:
    ...
    domain_transition = {
        ...
        "completion_receipt_consumption": {
            ...
            "eval_id": "publication-eval::previous",
            "work_unit_id": "previous_ai_reviewer_record",
