...
def test_domain_handler_export_exposes_domain_declared_transition_spec_without_domain_truth_write(
    tmp_path: Path,
    capsys,
) -> None:
    ...
    domain_handler_locator_payload = {"mas_family_domain_handler_export": payload}
    assert (
        resolve_json_pointer(domain_handler_locator_payload, descriptor["locator_refs"]["domain_handler_export_descriptor"])
        == descriptor
    )
    assert (
        resolve_json_pointer(domain_handler_locator_payload, descriptor["source_refs"]["domain_handler_export_descriptor"])
        == descriptor
    )
