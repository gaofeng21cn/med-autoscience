...
def test_paper_mission_drive_can_submit_opl_stage_route_via_public_enqueue(
    ...
    fake_opl = _write_fake_opl_stage_route_runtime(
        tmp_path / "fake-opl.py",
        capture_path=capture_path,
        task_id="frt_test_drive",
        running_stage_attempt_id="sat_test_drive",
    )
...
def test_paper_mission_drive_followthroughs_terminal_route_back_into_fresh_stage_route(
    ...
    capture_path = tmp_path / "opl-capture.json"
    fake_opl = _write_fake_opl_stage_route_runtime(
        tmp_path / "fake-opl-followthrough.py",
        capture_path=capture_path,
        task_id="frt_followthrough",
        running_stage_attempt_id="sat_running_followthrough",
        terminal_stage_attempt_id="sat_terminal_followthrough",
        terminal_on_first_readback=True,
        include_queue_stage_attempts=True,
    )
