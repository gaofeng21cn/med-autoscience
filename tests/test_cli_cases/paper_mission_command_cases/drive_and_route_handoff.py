...
def test_direct_write_handoff_carries_latest_task_intake_scope_into_runtime_request(
    ...
    runtime_submission = importlib.import_module(
        "med_autoscience.cli.paper_mission_commands.opl_runtime_submission"
    )
    study_id = "002-dm-china-us-mortality-attribution"
    workspace_root = tmp_path / "workspace"
...
from tests.test_cli_cases.paper_mission_command_cases.drive_and_route_handoff_cases.consumption_ledger_readback import (
    test_consumption_ledger_inspect_prefers_domain_transition_after_route_checkpoint,
    test_consumption_ledger_inspect_prefers_domain_transition_after_owner_consumed_route_checkpoint,
    test_consumption_ledger_inspect_ignores_stale_receipt_when_stage_closure_attempt_changes,
    test_consumption_ledger_inspect_prefers_domain_transition_after_consumed_route_checkpoint_when_work_unit_changes,
    test_consumption_ledger_inspect_prefers_same_stage_domain_transition_after_owner_consumed_route_checkpoint,
    test_consumption_ledger_inspect_attaches_study_progress_paper_mission_run_when_materialized_run_is_missing,
)
from tests.test_cli_cases.paper_mission_command_cases.drive_and_route_handoff_cases.domain_transition_routes import (
    test_paper_mission_drive_submits_domain_transition_next_action_without_candidate_package,
    test_paper_mission_drive_submits_current_paper_mission_next_action_envelope_without_candidate_package,
    test_paper_mission_drive_submits_authoritative_runtime_route_after_route_checkpoint,
    test_paper_mission_drive_submits_domain_transition_owner_workflow_after_route_back_checkpoint,
    test_paper_mission_drive_prefers_domain_next_action_over_current_opl_consumption,
    test_paper_mission_drive_ignores_stale_current_opl_consumption_after_owner_consumed_route_checkpoint,
    test_paper_mission_drive_halts_after_owner_apply_receipt_consumed,
)
from tests.test_cli_cases.paper_mission_command_cases.drive_and_route_handoff_cases.direct_next_action_and_opl_stage import (
    test_paper_mission_drive_still_submits_same_work_unit_after_owner_consumed_route_checkpoint,
    test_paper_mission_drive_does_not_resubmit_consumed_current_terminal_closeout,
    test_paper_mission_drive_resubmits_same_work_unit_when_next_action_fingerprint_changes,
    test_paper_mission_drive_does_not_resubmit_consumed_runtime_route_readback,
    test_paper_mission_drive_does_not_resubmit_owner_consumed_terminal_closeout,
    test_paper_mission_drive_stops_instead_of_repackaging_consumed_terminal_closeout,
    test_paper_mission_drive_stops_on_consumed_terminal_closeout_from_transaction_readback,
    test_paper_mission_drive_does_not_redrive_same_work_unit_after_owner_consumed_opl_transition_receipt,
    test_paper_mission_inspect_projects_domain_transition_running_attempt,
    test_paper_mission_inspect_projects_ai_reviewer_direct_stage_attempt,
    test_paper_mission_drive_can_submit_opl_stage_route_via_public_enqueue,
    test_paper_mission_drive_followthroughs_terminal_route_back_into_fresh_stage_route,
)
