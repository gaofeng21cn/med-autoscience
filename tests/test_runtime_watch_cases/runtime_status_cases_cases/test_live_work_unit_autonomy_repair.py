...
def _patch_runtime_watch_for_status(monkeypatch, module, status_payload: dict[str, object]) -> None:
...
def test_watch_runtime_applies_mas_controller_live_work_unit_repair_under_supervisor_only(
    ...
    _patch_runtime_watch_for_status(monkeypatch, module, status_payload)
