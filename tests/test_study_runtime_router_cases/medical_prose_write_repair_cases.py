...
def test_progress_projection_keeps_medical_prose_write_route_when_story_surface_delta_is_missing(
    ...
    study_root = write_study(
        ...
        paper_framing_summary="DPCC treatment-gap phenotype framing is fixed.",
        paper_urls=["https://example.org/dpcc-paper"],
        journal_shortlist=["BMC Medicine"],
        minimum_sci_ready_evidence_package=["primary_care_treatment_gap"],
    )
    quest_root = profile.runtime_root / "003-dpcc-primary-care-phenotype-treatment-gap"
    write_text(
    ...
    eval_id = (
        ...
        "003-dpcc-primary-care-phenotype-treatment-gap::2026-05-20T07:30:00+00:00"
    )
    work_unit = {
        ...
        json.dumps(
            {
                ...
                "quality_assessment": {
                    "medical_journal_prose_quality": {
                        "status": "blocked",
                        "summary": "Reviewer requests journal-level medical prose repair.",
                    }
                },
                "recommended_actions": [
                    {
                        "action_id": "return-to-write-medical-prose",
                        "action_type": "route_back_same_line",
                        "priority": "now",
                        "reason": "Medical prose remains below journal standard.",
                        "route_target": "write",
    ...
    write_text(
        ...
        json.dumps(
            {
                "schema_version": 1,
                "decision_id": "study-decision::003-dpcc::medical-prose-write-repair",
                "study_id": study_root.name,
                "quest_id": study_root.name,
                ...
                "route_rationale": "Medical prose still lacks a manuscript-facing repair delta.",
                "work_unit_fingerprint": "domain-transition::route_back_same_line::medical_prose_write_repair",
                "next_work_unit": work_unit,
            },
            ensure_ascii=False,
        ...
        json.dumps(
            {
                ...
                "work_unit": work_unit,
                "unit_statuses": [{"unit_id": "medical_prose_write_repair", "status": "owner_handoff"}],
    ...
    gate_report = {
        ...
        "controller_stage_note": "Medical prose repair still lacks a manuscript surface delta.",
    }
    monkeypatch.setattr(
        module,
...
def test_progress_projection_routes_completed_medical_prose_write_repair_to_ai_reviewer_recheck(
        ...
        json.dumps(
            {
                ...
                "next_work_unit": {
                    ...
                    "source_work_unit": {
                        ...
                        "lane": "write",
                        "summary": (
                            "Repair manuscript methods, treatment-gap definitions, display callouts, "
                            "limitations, and journal prose."
                        ),
                    },
                },
            },
    ...
    work_unit = {
        ...
        "lane": "write",
        "summary": (
            "Repair manuscript methods, treatment-gap definitions, display callouts, limitations, "
            "and journal prose."
        ),
    }
    lifecycle_payload = {
