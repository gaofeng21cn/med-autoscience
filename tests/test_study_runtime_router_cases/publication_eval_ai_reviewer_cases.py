        ...
        json.dumps(
            {
                ...
                "verdict": {
                    ...
                    "primary_claim_status": "blocked",
                    "summary": "Earlier submission authority blocker.",
                    "stop_loss_pressure": "watch",
                },
                "quality_assessment": {
                    "medical_journal_prose_quality": {
                        "status": "ready",
                        "summary": "AI reviewer judged the prose surface.",
                        "evidence_refs": [str(runtime_paper_root / "review" / "medical_prose_review.json")],
                    }
                },
                "gaps": [
                ...
                "recommended_actions": [
                    {
                        "action_id": "publication-eval-action::route_back_same_line::publication-blockers::old",
                        "action_type": "route_back_same_line",
                        "priority": "now",
                        "reason": "Earlier submission authority blocker.",
                        "route_target": "finalize",
                        "route_key_question": "当前论文线还差哪一个最窄的定稿或投稿包收尾动作？",
                        "route_rationale": "Earlier submission authority blocker.",
                        "evidence_refs": [str(gate_report_path)],
                        "requires_controller_decision": True,
...
def test_study_runtime_status_refreshes_publication_eval_when_gate_returns_to_publishability(
        ...
        json.dumps(
            {
                ...
                "verdict": {
                    "overall_verdict": "mixed",
                    "primary_claim_status": "supported",
                    "summary": "AI reviewer closed the earlier quality loop.",
                    "stop_loss_pressure": "none",
                },
                "gaps": [],
                "recommended_actions": [],
    ...
    monkeypatch.setattr(
        ...
        lambda state: {
            "schema_version": 1,
            "gate_kind": "publishability_control",
            "generated_at": "2026-04-30T12:30:58+00:00",
            "quest_id": "001-risk",
            "paper_root": str(runtime_paper_root),
            "latest_gate_path": str(gate_report_path),
            "status": "blocked",
            ...
            "deferred_downstream_actions": [],
            "controller_stage_note": "return to publishability gate",
        },
    )
