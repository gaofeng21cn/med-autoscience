...
def test_atlas_spatial_trajectory_multimanifold_context_support_panel_is_registered() -> None:
    ...
    assert spec.evidence_class == "data_geometry"
    assert spec.renderer_family == "python"
    assert spec.input_schema_id == "atlas_spatial_trajectory_multimanifold_context_support_panel_inputs_v1"
    assert spec.layout_qc_profile == "publication_atlas_spatial_trajectory_multimanifold_context_support_panel"
...
def test_celltype_marker_dotplot_panel_is_registered() -> None:
    spec = display_registry.get_evidence_figure_spec(_full_id("celltype_marker_dotplot_panel"))

    assert spec.paper_family_ids == ("D", "E", "G")
    assert spec.evidence_class == "matrix_pattern"
    assert spec.renderer_family == "r_ggplot2"
    assert spec.input_schema_id == "celltype_marker_dotplot_panel_inputs_v1"
    assert spec.layout_qc_profile == "publication_celltype_marker_dotplot_panel"
...
def test_time_to_event_publication_surface_specs_are_registered() -> None:
    ...
    figure10e = display_registry.get_evidence_figure_spec(_full_id("celltype_marker_dotplot_panel"))
    ...
    assert figure8.renderer_family == "r_ggplot2"
    ...
    assert figure9b.renderer_family == "r_ggplot2"
    ...
    assert figure10d.renderer_family == "r_ggplot2"
    ...
    assert figure10e.paper_family_ids == ("D", "E", "G")
    assert figure10e.evidence_class == "matrix_pattern"
    assert figure10e.renderer_family == "r_ggplot2"
    assert figure10e.input_schema_id == "celltype_marker_dotplot_panel_inputs_v1"
    assert figure10e.layout_qc_profile == "publication_celltype_marker_dotplot_panel"
    ...
    assert figure13.renderer_family == "r_ggplot2"
    ...
    assert figure13b.renderer_family == "r_ggplot2"
    ...
    assert figure13c.renderer_family == "r_ggplot2"
    ...
    assert figure14.renderer_family == "r_ggplot2"
    ...
    assert figure17b.renderer_family == "r_ggplot2"
