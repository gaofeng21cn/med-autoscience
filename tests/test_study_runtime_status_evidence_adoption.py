...
def test_study_runtime_status_projects_adopted_work_unit_evidence_without_runtime_recovery(
    monkeypatch,
    tmp_path: Path,
) -> None:
    ...
    result = module.study_runtime_status(profile=profile, study_id=study_id, include_progress_projection=False)
