...
def test_supervisor_scan_clears_stale_package_terminal_when_current_controller_runtime_work_unit_is_current(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_supervisor_scan_writes_current_controller_authorization_before_no_live_redrive(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_resumes_waiting_controller_work_unit_pending_after_authorization_written(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_derives_live_activity_timeout_from_progress_when_runtime_health_is_still_live(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_blocks_pending_redrive_when_resume_adopts_evidence_without_live_worker(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
