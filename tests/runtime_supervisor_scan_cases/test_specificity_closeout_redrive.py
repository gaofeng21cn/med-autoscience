...
def test_supervisor_scan_redrives_publication_gate_closeout_after_specificity_targets_resolve(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_supervisor_scan_redrives_controller_authorized_paper_line_owner_closeout_after_targets_resolve(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_redrives_mas_controller_closeout_when_specificity_authorization_is_stale(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_redrives_mas_controller_closeout_when_authorization_was_cleared(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
...
def test_supervisor_scan_resumes_pending_platform_redrive_after_stale_specificity_clear(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
