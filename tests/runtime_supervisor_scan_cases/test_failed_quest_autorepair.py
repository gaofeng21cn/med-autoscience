...
def test_supervisor_scan_routes_failed_non_resumable_quest_to_platform_repair(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_supervisor_scan_explicit_runtime_platform_repair_relaunches_failed_non_resumable_quest(
    monkeypatch,
    tmp_path: Path,
) -> None:
    ...
    def fake_study_runtime_status(**_: object) -> dict[str, object]:
    ...
    monkeypatch.setattr(module.study_runtime_router, "study_runtime_status", fake_study_runtime_status)
