...
def test_supervisor_scan_redrives_mas_controller_owner_handoff_for_current_paper_work(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_supervisor_scan_applies_authorized_controller_work_unit_wait_redrive(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.runtime_supervisor_scan")
