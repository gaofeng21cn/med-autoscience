...
from tests.owner_route_reconcile_cases.owner_route_test_helpers import (
...
def test_platform_repair_prefers_methodology_reframe_route_over_stale_gate_specificity(
    ...
    repair_module = importlib.import_module("med_autoscience.controllers.owner_route_reconcile_parts.platform_repair")
    profile = make_profile(tmp_path)
    study_id = "002-dm-china-us-mortality-attribution"
    quest_id = study_id
    study_root = write_study(profile.workspace_root, study_id, quest_id=quest_id)
