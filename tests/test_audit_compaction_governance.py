...
def test_audit_compaction_governance_builds_maintainability_read_model(tmp_path: Path) -> None:
    ...
    repo_root = tmp_path
    domain_diagnostic_report = repo_root / "src/med_autoscience/controllers/provider_admission/provider_admission_report.py"
    ...
    fitness_report = boundary.audit_boundary_fitness(
        ...
        baseline={
            ...
            "src/med_autoscience/controllers/provider_admission/provider_admission_report.py": 1010,
        },
    )
...
def test_audit_compaction_governance_validation_fails_closed_on_authority_cleanup_and_gate_drift() -> None:
    ...
    report["structure_target_list"]["top_targets"] = [
        {"path": "src/med_autoscience/controllers/provider_admission/provider_admission_report.py", "action_kind": "mechanical_split"}
    ]
