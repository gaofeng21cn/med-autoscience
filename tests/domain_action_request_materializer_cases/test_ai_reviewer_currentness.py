...
from tests.domain_action_request_materializer_cases.ai_reviewer_request_refresh_cases import (
    test_materialize_domain_action_requests_refreshes_existing_ai_reviewer_request_to_latest_valid_record_without_new_queue_task,
    test_ai_reviewer_request_refresh_adopts_owner_route_less_record_production_output_by_work_unit,
    test_ai_reviewer_request_refresh_uses_record_production_payload_when_request_lacks_work_unit_identity,
    test_materialize_current_ai_reviewer_record_work_unit_routes_to_publication_owner_when_current,
    test_materialize_current_ai_reviewer_record_work_unit_routes_missing_currentness_to_ai_reviewer,
)
...
def test_materialize_domain_action_requests_honors_consumed_transition_owner_action(
    ...
    assert dispatch["prompt_contract_ref"]["owner_route_ref"]["source_refs"]["work_unit_id"] == (
        "dpcc_publication_gate_replay_after_current_ai_reviewer_record"
    )
...
def test_materialize_domain_action_requests_keeps_repair_progress_recheck_queue_over_old_routeback_record(
    ...
    assert "materialization_decision" not in dispatch["source_action_ref"]
...
def test_materialize_ai_reviewer_request_preserves_current_manuscript_record_refs(
    ...
    assert dispatch["source_action_ref"]["required_currentness_refs"] == expected_refs
    assert dispatch["source_action_ref"]["stale_record_ref"] == str(stale_record_ref.resolve())
    ...
    assert dispatch["source_action_ref"]["controller_decision_write_allowed"] is False
