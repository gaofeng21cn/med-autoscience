...
def test_projections_reject_incomplete_new_kind_receipt() -> None:
    ...
    assert _opl_transition_receipt(
        summary={
            "opl_runtime_carrier": carrier,
            "opl_transition_receipt": incomplete,
        }
    ) == {}
    ...
    assert monitoring["opl_transition_receipt"] is None
...
def test_projections_keep_valid_canonical_receipt_without_receipt_study_id() -> None:
    ...
    assert monitoring["opl_transition_receipt"]["domain_route_handoff_ref"].endswith(
