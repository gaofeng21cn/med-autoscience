...
def test_clear_bundle_gate_routes_back_to_review_when_medical_prose_quality_is_not_ready(
    ...
    assert action.route_key_question == "Which AI-reviewer manuscript-quality issue must close before finalize?"
