    ...
    gate_route.update(
        {
            ...
            "source_fingerprint": f"domain-transition::route_back_same_line::{work_unit_id}",
            "failure_signature": work_unit_id,
            "owner_reason": work_unit_id,
            "idempotency_key": f"owner-route::{study_id}::gate-clearing::{work_unit_id}",
            "source_refs": {
                "work_unit_id": work_unit_id,
                "work_unit_fingerprint": f"domain-transition::route_back_same_line::{work_unit_id}",
                "blocked_reason": work_unit_id,
                "receipt_ref": "artifacts/publication_eval/ai_reviewer_responses/current.json",
            },
        }
    )
