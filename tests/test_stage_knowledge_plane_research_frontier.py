...
def test_rollback_target_policy_uses_8_stage_pack_advisory_mapping() -> None:
    ...
    assert suggestions[("stop-line", "stop_loss")]["suggested_target_stage"] == "07-quality_review_and_revision"
...
def test_failure_scope_maps_to_specific_8_stage_rollback_target() -> None:
    failure_scopes = [
        ...
        ("reviewer_quality", "07-quality_review_and_revision"),
...
def test_failed_frontier_paths_project_stop_loss_and_route_back_target(tmp_path) -> None:
    ...
    assert suggestions[("weak-endpoint-line", "stop_loss")] == "07-quality_review_and_revision"
