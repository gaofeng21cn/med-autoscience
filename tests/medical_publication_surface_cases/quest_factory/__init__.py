...
from tests.medical_publication_surface_cases.quest_factory.time_to_event_direct_migration import _write_time_to_event_direct_migration_surface
from tests.medical_publication_surface_cases.quest_factory_numeric_trace import write_numeric_trace_fixture
from tests.medical_publication_surface_cases.reproducibility_fixture import write_reproducibility_supplement_fixture
from tests.medical_publication_surface_cases.statistical_disclosure_fixtures import write_statistical_reviewer_audit_fixture, write_structured_disclosure_audit_fixture
def make_quest(
    tmp_path: Path,
    *,
    medicalized: bool,
