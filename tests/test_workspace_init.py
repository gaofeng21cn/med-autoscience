...
from tests.test_workspace_init_cases.portable_supervisor_scheduler import *  # noqa: F403,F401
...
def test_init_workspace_creates_minimal_workspace_and_entry_files(tmp_path: Path) -> None:
    ...
    assert ' uv run --directory "${MED_AUTOSCIENCE_REPO_RESOLVED}"' not in ds_shared_text
