...
def test_scan_domain_routes_queues_runtime_repair_for_abnormal_stopped_resume_required(
    monkeypatch,
    tmp_path: Path,
) -> None:
...
def test_scan_domain_routes_explicit_runtime_platform_repair_relaunches_abnormal_stopped_runtime(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
...
def test_scan_domain_routes_explicit_runtime_platform_repair_relaunches_active_runtime_with_no_live_worker(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
...
def test_scan_domain_routes_blocks_runtime_platform_repair_when_relaunch_starts_no_live_run(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
...
def test_scan_domain_routes_queues_runtime_repair_for_paused_resume_without_live_worker(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
...
def test_scan_domain_routes_runtime_repair_routes_controller_gate_skip_to_publication_gate(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
...
def test_scan_domain_routes_clears_stale_specificity_terminal_when_targets_are_complete(
    monkeypatch,
    tmp_path: Path,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.domain_route_scan")
