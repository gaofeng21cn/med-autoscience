...
def test_owner_route_legacy_scan_part_reexports_shared_contract() -> None:
    ...
    legacy = importlib.import_module("med_autoscience.controllers.domain_route_scan_parts.owner_route")
...
def test_owner_route_scan_consumer_and_executor_share_contract_import() -> None:
    shared = importlib.import_module("med_autoscience.runtime_control.owner_route")
    modules = [
        importlib.import_module("med_autoscience.controllers.domain_route_scan"),
...
def test_scan_domain_routes_routes_no_live_current_controller_work_unit_without_external_supervisor(
    monkeypatch,
    tmp_path: Path,
) -> None:
    scan = importlib.import_module("med_autoscience.controllers.domain_route_scan")
