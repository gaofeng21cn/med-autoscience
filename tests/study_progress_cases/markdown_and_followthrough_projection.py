...
from . import quality_followthrough_projection as _quality_followthrough_projection
    ...
    markdown = module.render_study_progress_markdown(
        {
            ...
            "study_macro_state": {
                ...
                "user_next": "repair",
                "reason": "quality",
                "details": {"package_delivered": False, "paper_stage": "publishability_gate_blocked"},
                "conditions": [],
            },
            "user_visible_projection": {
                ...
                "state_summary": "论文可发表性监管仍有硬阻塞。",
                "current_stage": "queued",
                "current_stage_summary": "论文可发表性监管仍有硬阻塞。",
                "paper_stage": "publishability_gate_blocked",
                "current_blockers": [
                    "missing_submission_minimal",
                    "medical_publication_surface_blocked",
    ...
    markdown = module.render_study_progress_markdown(
        {
            ...
            "study_macro_state": {
                ...
                "details": {"package_delivered": True, "paper_stage": "bundle_stage_ready"},
                "conditions": [],
            },
            "user_visible_projection": {
                "surface": "study_progress_user_visible_projection",
                ...
                "state_summary": "当前状态：投稿包已交付，等待外部投稿信息；当前卡点：论文展示注册表与 reporting contract 不一致，需要先修正稿面契约。",
                "current_stage": "parked",
                "current_stage_summary": "当前状态：投稿包已交付，等待外部投稿信息；当前卡点：论文展示注册表与 reporting contract 不一致，需要先修正稿面契约。",
                "paper_stage": "bundle_stage_ready",
                "current_blockers": ["论文展示注册表与 reporting contract 不一致，需要先修正稿面契约。"],
                "next_system_action": "优先核对 submission package 与 studies 目录中的交付面是否一致。",
                "evidence": {"latest_events": [], "refs": {}},
                "conditions": [],
            },
            "latest_events": [],
