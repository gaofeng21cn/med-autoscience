...
def test_stage_review_projects_research_pack_progress_summary_body_free() -> None:
        ...
        **_stage_review_payload(),
        "research_evidence_pack_summary": {
            ...
            "progress_summary": {
                ...
                "missing_reproducibility_refs": ["software_environment_refs", "parameter_seed_refs"],
    ...
    assert summary["single_next_owner_blocker"]["ref"] == "studies/001-risk/artifacts/blockers/next-owner.json"
