...
def test_build_runtime_readback_outer_loop_tick_request_stops_live_runtime_after_fast_lane_closeout(
    tmp_path: Path,
...
def test_build_runtime_readback_outer_loop_tick_request_does_not_stop_when_fast_lane_closeout_has_blocked_gate(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
