...
from tests.test_study_outer_loop_cases.shared import (
...
def test_domain_diagnostic_report_outer_loop_routes_startup_freshness_gate_before_stale_task_intake(
    tmp_path: Path,
    ...
    monkeypatch.setattr(_domain_diagnostic_report_tick_request_module().publication_gate_controller, "build_gate_report", lambda state: dict(gate_report))
...
def test_domain_diagnostic_report_outer_loop_routes_startup_freshness_gate_before_publication_eval_work_unit(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
...
def test_domain_diagnostic_report_outer_loop_routes_bundle_stage_ready_before_stale_task_intake(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
...
def test_domain_diagnostic_report_outer_loop_routes_bundle_ready_eval_review_unit_to_finalize_work_unit(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
...
def test_domain_diagnostic_report_outer_loop_routes_bundle_blocked_eval_review_unit_to_finalize_work_unit(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
...
def test_domain_diagnostic_report_outer_loop_keeps_current_write_task_intake_before_clear_bundle_gate(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    module = importlib.import_module("med_autoscience.controllers.study_outer_loop")
