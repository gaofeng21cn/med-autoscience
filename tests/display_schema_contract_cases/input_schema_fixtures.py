...
_INPUT_SCHEMAS = {
    ...
    "time_to_event_threshold": "time_to_event_threshold_governance_inputs_v1",
    ...
    "shap_bar": "shap_bar_importance_inputs_v1",
    "shap_multicohort": "shap_multicohort_importance_panel_inputs_v1",
    "shap_dependence": "shap_dependence_panel_inputs_v1",
    "shap_waterfall": "shap_waterfall_local_explanation_panel_inputs_v1",
    "shap_force": "shap_force_like_summary_panel_inputs_v1",
