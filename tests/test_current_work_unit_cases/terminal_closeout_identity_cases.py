...
def test_current_work_unit_uses_owner_gate_current_identity_for_stage_packet_blocker() -> None:
    module = _module()
    study_id = "002-dm-china-us-mortality-attribution"
    work_unit_id = "analysis_claim_evidence_repair"
    current_fingerprint = "publication-blockers::497d1260db522f01"
    ...
    work_unit = module.build_current_work_unit(
        ...
        typed_blocker={
            ...
            "required_owner_action": (
                "provide or admit a current stage packet for "
                f"{work_unit_id}/{current_fingerprint}, or consume an owner receipt/typed blocker "
                "that matches the current MAS work-unit identity"
            ),
            "blocked_reasons": [
                "fresh_opl_current_control_work_unit_fingerprint_publication-blockers::497d1260db522f01",
            ],
            "source_ref": closeout_ref,
            "typed_blocker_ref": closeout_ref,
            "currentness_basis": {
