...
RETIRED_RUNTIME_WATCH_HELPERS = (
    Path("src/med_autoscience/controllers/provider_attempt/runtime_scan.py"),
    Path("src/med_autoscience/controllers/provider_attempt/managed_recovery.py"),
    Path("src/med_autoscience/controllers/provider_attempt/authority_dispatch_gate.py"),
    Path("src/med_autoscience/controllers/provider_attempt/gate_specificity.py"),
)
...
def test_runtime_scan_uses_runtime_control_ports_for_controller_execution() -> None:
    path = Path("src/med_autoscience/controllers/provider_attempt/runtime_scan.py")
