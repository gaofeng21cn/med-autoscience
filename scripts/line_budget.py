...
BASELINE = {
    ...
    'src/med_autoscience/controllers/publication_gate.py': 1960,
    'src/med_autoscience/controllers/runtime_watch.py': 1499,
    'src/med_autoscience/controllers/study_delivery_sync.py': 2402,
    ...
    'src/med_autoscience/controllers/study_runtime_decision.py': 2562,
    'src/med_autoscience/controllers/study_runtime_execution.py': 1346,
    'src/med_autoscience/controllers/study_runtime_status.py': 1843,
    ...
    'src/med_autoscience/evaluation_summary.py': 2678,
    ...
    'tests/test_cli.py': 2838,
    'tests/test_evaluation_summary.py': 1399,
    'tests/test_gate_clearing_batch.py': 1773,
    'tests/test_publication_gate.py': 3112,
    'tests/test_runtime_transport_med_deepscientist.py': 2209,
    'tests/test_runtime_watch.py': 3938,
    'tests/test_study_delivery_sync.py': 1117,
    'tests/test_study_outer_loop.py': 2732,
    'tests/test_study_runtime_router.py': 11353,
    'tests/test_study_runtime_typed_surface.py': 1087,
}
CODE_EXTENSIONS = {
    ".py",
    ".js",
