...
- MAS 的 canonical plugin source 在 `plugins/med-autoscience/`；旧 `plugins/mas` 已物理退役。repo-local `.agents/plugins/marketplace.json` 是已退役本地状态，Codex marketplace 注册由 OPL wrapper / startup maintenance surface 持有。
