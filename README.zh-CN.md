...
- MAS 只维护 `plugins/mas/` 下的 plugin source；repo-local `.agents/plugins/marketplace.json` 是已退役本地状态，Codex marketplace 注册由 OPL wrapper / startup maintenance surface 持有。
