...
Use a typed blocker only when no consumable delta exists, authority/currentness
is invalid, or a real safety, credential, irreversible-action, or human decision
gate applies. Ambiguous completion remains invalid because it lets runtime
progress replace medical authority.
