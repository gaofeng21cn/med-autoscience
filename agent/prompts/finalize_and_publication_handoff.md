...
debt and block publication/submission-ready claims. Return a scoped route-back,
typed blocker, or human gate when no consumable handoff exists or when quality,
authority, currentness, credential, irreversible-action, or human-decision
requirements prevent safe progress.
