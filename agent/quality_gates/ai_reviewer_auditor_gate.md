...
refs. The debt blocks ready claims. Use a typed blocker when there is no
consumable packet or when authority, safety, identity, currentness, credential,
irreversible-action, or human-decision requirements prevent safe progress.
