# Bounded Analysis Campaign Policy
...
substituting an analysis. Tool choice is flexible inside those scientific
dependencies, and methods drafting may iterate with evidence work.
