...
4. Prefer the installed `mas-scholar-skills` capability package for focused medical methods. If it is absent or incompatible, continue through the MAS-owned Stage with explicit professional-capability diagnostics and quality debt; do not turn an optional enhancement gap into a typed blocker. Acquire another external Skill only for a named or demonstrated coverage gap after provenance, permissions, data/credential scope, and compatibility review.
...
- Missing or incompatible professional Skills may limit the affected quality, publication, export, or submission-ready claim, but they do not block MAS admission, routing, authoring, or analysis when the MAS-owned Stage can still produce a consumable delta.
